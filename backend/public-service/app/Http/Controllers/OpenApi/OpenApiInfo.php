 ...
 * @OA\Info(
 *     version="1.0.0",
 *     title="My Unila Public Service API",
 *     description="Public Service - University Profile, Rankings, Statistics, and Public Information",
 *     @OA\Contact(
 ...
 *
 * @OA\Server(
 *     url="http://localhost:9800/public-service/api/v1",
 *     description="Local Development (via Kong Gateway)"
 * )
 *
 * @OA\Server(
 *     url="https://api.unila.ac.id/public-service/api/v1",
