...
/**
 * Middleware permission check untuk si-kkn-service.
 * Cek akses CRUD berdasarkan role pengguna di pdut.
 *
 * Usage: Route::post('/...')->middleware('permission:insert,si-kkn');
 *
 * Default app_key: si-kkn (pastikan slug ini ada di man_akses.aplikasi)
 */
