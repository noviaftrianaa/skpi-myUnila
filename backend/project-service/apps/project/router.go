...
func initRoutes(router fiber.Router, h *Handler) {
	...
	pg.Get("/:id/tasks/:taskId/assignees", h.GetTaskAssignees)
	pg.Post("/:id/tasks/:taskId/assignees", h.AddTaskAssignee)
	pg.Delete("/:id/tasks/:taskId/assignees/:userId", h.RemoveTaskAssignee)
