...
import (
	...
	"github.com/myunila/feeder-service/docs/openapi"
	"github.com/myunila/feeder-service/internal/middleware"
	"gopkg.in/yaml.v3"
)
...
<head>
    ...
    <title>Feeder Service API Documentation</title>
...
<body>
    <div class="loading-screen" id="loading">
        ...
        <div class="loading-subtext">Loading Feeder Service API Documentation...</div>
    </div>
    ...
    <script>
        var configuration = {
            ...
            metaData: {
                ...
                description: 'API untuk sinkronisasi data dari Neo Feeder PDDIKTI',
                ogDescription: 'Feeder Service API Documentation - Universitas Lampung',
                ogTitle: 'Feeder Service API Docs',
            },
            customCss: ` + "`" + `
