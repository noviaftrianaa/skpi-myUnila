...
class RoleScopeFilter
{
    ...
    /**
     * Decode JWT dari Authorization header → claim `sub` = id_pengguna.
     *
     * Kalau JWT_SECRET tidak di-set di env, fallback: ambil dari header
     * X-User-Id (untuk testing & service-to-service trust di belakang Kong).
     */
