...
class PengabdianDetailRepository
{
    /**
     * Get pengabdian basic information
     *
     * @param string $idLitabmas
     * @return object|null
     */
    public function getPengabdianBasicInfo(string $idLitabmas): ?object
    {
        $sql = "
            SELECT
                l.id_litabmas,
    ...
    /**
     * Get anggota pengabdian (team members)
     *
     * @param string $idLitabmas
     * @return array
     */
    public function getAnggotaPengabdian(string $idLitabmas): array
    {
        $sql = "
    ...
    /**
     * Get publikasi yang dihasilkan dari pengabdian ini
     *
     * @param string $idLitabmas
     * @return array
     */
    public function getPublikasiPengabdian(string $idLitabmas): array
    {
        $sql = "
            SELECT
                p.id_publikasi,
    ...
    /**
     * Get luaran lainnya dari pengabdian (HKI, paten, dll)
     *
     * @param string $idLitabmas
     * @return array
     */
    ...
    /**
     * Get mahasiswa yang terlibat dalam pengabdian
     *
     * @param string $idLitabmas
     * @return array
     */
    public function getMahasiswaPengabdian(string $idLitabmas): array
    {
