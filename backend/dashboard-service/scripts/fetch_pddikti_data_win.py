...
try:
    ...
    print("ERROR Error: pddiktipy not installed")
...
class PDDiktiDataFetcher:
        ...
        try:
            with api() as client:
                ...
                if not search_results:
                    print("WARNING  No results found for Universitas Lampung")
                    return None
                ...
                if not unila:
                    print("WARNING  Exact match for Universitas Lampung not found")
                ...
                if pt_id:
                    ...
                    print(f"OK University data fetched successfully")
                    return self.unila_data
                else:
                    print("WARNING  PT ID not found in search results")
                    return unila
    ...
    def fetch_study_programs_accreditation(self) -> List[Dict]:
        ...
        try:
            with api() as client:
                ...
                print(f"\nOK Successfully fetched {len(detailed_prodi)} study programs")
    ...
    def export_to_json(self):
        ...
        if self.unila_data:
            ...
            print(f"OK University data exported to: {unila_file}")
        ...
        if self.prodi_data:
            ...
            print(f"OK Study programs data exported to: {prodi_file}")
    ...
    def run(self):
        ...
        print("\nSUCCESS Data fetch completed successfully!")
