...
class PortalAplikasiSeeder extends Seeder
{
    ...
    private function seedKategori(): array
    {
        ...
        $kategoris = [
            ...
            ['nm_kategori' => 'Dashboard & Akreditasi', 'icon_kategori' => 'heroicons:chart-pie', 'icon_color' => 'bg-indigo-500', 'urutan' => 5],
            ['nm_kategori' => 'Data dan Pelaporan', 'icon_kategori' => 'heroicons:server-stack', 'icon_color' => 'bg-cyan-500', 'urutan' => 6],
            ['nm_kategori' => 'Layanan', 'icon_kategori' => 'ph:headset-fill', 'icon_color' => 'bg-red-500', 'urutan' => 7],
    ...
    private function getAplikasiData(): array
    {
        return [
            ...
            ['app_slug' => 'e-kkn', 'nm_aplikasi' => 'E-KKN', 'ket_aplikasi' => 'Sistem Kuliah Kerja Nyata', 'url' => '#', 'icon_name' => 'heroicons:globe-alt', 'icon_color' => 'text-teal-600', 'kategori' => 'Akademik', 'urutan' => 3, 'id_organisasi' => self::ORG_SEMUA_UNIT, 'a_terintegrasi' => false, 'a_coming_soon' => true],
            ...
            ['app_slug' => 'wali', 'nm_aplikasi' => 'Wali', 'ket_aplikasi' => 'Sistem Perwalian', 'url' => '#', 'icon_name' => 'heroicons:users', 'icon_color' => 'text-blue-700', 'kategori' => 'Akademik', 'urutan' => 6, 'id_organisasi' => self::ORG_SEMUA_UNIT, 'a_terintegrasi' => false, 'a_coming_soon' => true],
            ...
            ['app_slug' => 'sikep', 'nm_aplikasi' => 'SIKEP', 'ket_aplikasi' => 'Sistem Kepegawaian', 'url' => '#', 'icon_name' => 'heroicons:identification', 'icon_color' => 'text-slate-600', 'kategori' => 'Akademik', 'urutan' => 8, 'id_organisasi' => self::ORG_UNILA, 'a_terintegrasi' => false, 'a_coming_soon' => true],
            ['app_slug' => 'spmi', 'nm_aplikasi' => 'SPMI', 'ket_aplikasi' => 'Sistem Penjaminan Mutu Internal', 'url' => '#', 'icon_name' => 'heroicons:chart-bar', 'icon_color' => 'text-green-700', 'kategori' => 'Akademik', 'urutan' => 9, 'id_organisasi' => self::ORG_SEMUA_UNIT, 'a_terintegrasi' => false, 'a_coming_soon' => true],
            ...
            ['app_slug' => 'sikerma', 'nm_aplikasi' => 'SIKERMA', 'ket_aplikasi' => 'Sistem Kerjasama Institusi', 'url' => '#', 'icon_name' => 'heroicons:building-office', 'icon_color' => 'text-blue-700', 'kategori' => 'Riset dan Kerjasama', 'urutan' => 4, 'id_organisasi' => self::ORG_UNILA, 'a_terintegrasi' => false, 'a_coming_soon' => true],
            ...
            ['app_slug' => 'api-gateway', 'nm_aplikasi' => 'API Gateway', 'ket_aplikasi' => 'Kong Dashboard', 'url' => '/portal/kong-admin', 'icon_name' => 'heroicons:cube', 'icon_color' => 'text-slate-600', 'kategori' => 'Tools & Utilities', 'urutan' => 1, 'id_organisasi' => self::ORG_UPT_TIK, 'a_terintegrasi' => true, 'a_coming_soon' => false],
