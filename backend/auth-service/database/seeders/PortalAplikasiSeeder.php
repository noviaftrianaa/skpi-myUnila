...
class PortalAplikasiSeeder extends Seeder
{
    ...
    private function getAplikasiData(): array
    {
        return [
            ...
            ['app_slug' => 'si-prestasi', 'nm_aplikasi' => 'SI Prestasi', 'ket_aplikasi' => 'Sistem Informasi Prestasi Mahasiswa — integrasi SIMKATMAWA', 'url' => '/dashboard/si-prestasi', 'icon_name' => 'heroicons:trophy', 'icon_color' => 'text-yellow-600', 'kategori' => 'Kemahasiswaan', 'urutan' => 1, 'id_organisasi' => self::ORG_SEMUA_UNIT, 'a_terintegrasi' => true, 'a_coming_soon' => false],
            ...
            ['app_slug' => 'blog-unila', 'nm_aplikasi' => 'Blog Unila', 'ket_aplikasi' => 'Portal publikasi civitas — kumpulan artikel mahasiswa, dosen, staf di blog.unila.ac.id', 'url' => 'http://localhost:3002', 'icon_name' => 'heroicons:newspaper', 'icon_color' => 'text-pink-600', 'kategori' => 'Layanan', 'urutan' => 2, 'id_organisasi' => self::ORG_SEMUA_UNIT, 'a_terintegrasi' => true, 'a_coming_soon' => false, 'a_live' => true],
            ['app_slug' => 'blog-platform', 'nm_aplikasi' => 'Blog Platform', 'ket_aplikasi' => 'Author panel — kelola blog pribadi, klaim subdomain, tulis & publish artikel ke blog.unila.ac.id', 'url' => '/dashboard/blog-platform', 'icon_name' => 'heroicons:pencil-square', 'icon_color' => 'text-blue-600', 'kategori' => 'Layanan', 'urutan' => 3, 'id_organisasi' => self::ORG_SEMUA_UNIT, 'a_terintegrasi' => true, 'a_coming_soon' => false, 'a_live' => true],
            ...
            ['app_slug' => 'manajemen-konten', 'nm_aplikasi' => 'Manajemen Konten', 'ket_aplikasi' => 'Pengumuman, berita, & artikel portal myUnila (sub-modul Manajemen Apps)', 'url' => '/dashboard/manajemen-apps/manajemen-konten', 'icon_name' => 'heroicons:newspaper', 'icon_color' => 'text-emerald-600', 'kategori' => 'Tools & Utilities', 'urutan' => 5, 'id_organisasi' => self::ORG_UPT_TIK, 'a_terintegrasi' => true, 'a_coming_soon' => false],
            ['app_slug' => 'manajemen-apps', 'nm_aplikasi' => 'Manajemen Apps', 'ket_aplikasi' => 'Shell manajemen modul-modul aplikasi MyUnila (manajemen konten, pengguna, aplikasi, dst)', 'url' => '/dashboard/manajemen-apps', 'icon_name' => 'heroicons:squares-2x2', 'icon_color' => 'text-purple-600', 'kategori' => 'Tools & Utilities', 'urutan' => 6, 'id_organisasi' => self::ORG_UPT_TIK, 'a_terintegrasi' => true, 'a_coming_soon' => false],
        ];
    }
}
