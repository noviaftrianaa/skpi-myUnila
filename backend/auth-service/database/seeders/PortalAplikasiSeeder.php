...
class PortalAplikasiSeeder extends Seeder
{
    ...
    private function getAplikasiData(): array
    {
        return [
            ...
            ['app_slug' => 'simba', 'nm_aplikasi' => 'SIMBA', 'ket_aplikasi' => 'Sistem Informasi Bagian Akademik', 'url' => '#', 'icon_name' => 'heroicons:building-library', 'icon_color' => 'text-indigo-600', 'kategori' => 'Akademik', 'urutan' => 10, 'id_organisasi' => self::ORG_SEMUA_UNIT, 'a_terintegrasi' => false, 'a_coming_soon' => true],
