...
{
    /**
     * Display Scalar API documentation
     */
    ...
    <script>
        var configuration = {
            ...
            metaData: {
                ...
                description: 'Authentication & Authorization Service untuk platform myUnila',
                ogDescription: 'Auth Service API Documentation - Universitas Lampung',
                ogTitle: 'Auth Service API Docs',
            },
            customCss: `
        ...
        if (!file_exists($path)) {
            ...
            if (!file_exists($path)) {
                return response()->json([
                    'error' => 'OpenAPI spec not found. Please run: php artisan l5-swagger:generate'
                ], 404);
            }
        }
