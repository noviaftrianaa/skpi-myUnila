...
<head>
    ...
    <title>myUnila Integrator Service API Documentation</title>
...
<body>
    <div class="loading-screen" id="loading">
        ...
        <div class="loading-subtext">Loading myUnila Integrator Service API Documentation...</div>
    </div>
    ...
    <script>
        var configuration = {
            ...
            metaData: {
                title: 'myUnila Integrator Service API',
                description: 'API untuk integrasi dan sinkronisasi data dari sistem eksternal',
                ogDescription: 'myUnila Integrator Service API Documentation - Universitas Lampung',
                ogTitle: 'myUnila Integrator Service API Docs',
            },
            customCss: ` + "`" + `
