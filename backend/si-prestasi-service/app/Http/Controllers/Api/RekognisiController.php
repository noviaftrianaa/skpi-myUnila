...
use App\Services\RekognisiService;
...
/**
 * RekognisiController — CRUD prestasi.rekognisi (dosen/prodi dikenal internasional).
 */
class RekognisiController extends Controller
{
    ...
    public function __construct(
        protected RekognisiService $service,
    ) {}
    ...
    public function index(Request $request): JsonResponse
    {
        $request->validate([
            ...
            'id_jenis_rekognisi' => 'nullable|uuid',
        ...
        $result = $this->service->list(
            $request->only(['tahun', 'id_fakultas', 'id_jenis_rekognisi', 'status_workflow', 'search']),
            $page, $limit
        );
    ...
    public function show(string $id): JsonResponse
    {
        ...
        if (!$data) return $this->notFoundResponse('Rekognisi tidak ditemukan');
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return $this->successResponse($created, 'Rekognisi dibuat', 201);
    }
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        if (!$updated) return $this->notFoundResponse('Rekognisi tidak ditemukan atau tidak dapat diupdate');
        return $this->successResponse($updated, 'Rekognisi diupdate');
    }
    ...
    public function destroy(Request $request, string $id): JsonResponse
    {
        ...
        if (!$ok) return $this->notFoundResponse('Rekognisi tidak ditemukan');
        return $this->successResponse(null, 'Rekognisi dihapus');
    }
    ...
    public function transition(Request $request, string $id): JsonResponse
    {
        ...
        if (!$updated) return $this->notFoundResponse('Rekognisi tidak ditemukan');
    ...
    private function validatePayload(Request $request): array
    {
        return $request->validate([
            ...
            'id_jenis_rekognisi' => 'required|uuid',
            'nm_rekognisi' => 'required|string|max:255',
