...
{
    protected StatusKepegawaianService $statusKepegawaianService;

    public function __construct(StatusKepegawaianService $statusKepegawaian)
    {
        $this->statusKepegawaianService = $statusKepegawaian;
    }
     ...
     */
    public function getStatusKepegawaianFakultas(Request $request)
    {
        try {
            $idThnAjaran = $request->query('tahun_ajaran');
            $data = $this->statusKepegawaianService->getStatusKepegawaianFakultas($idThnAjaran);
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getStatusKepegawaianProdi(Request $request, $idFakultas)
    {
        try {
            $idThnAjaran = $request->query('tahun_ajaran');
            $data = $this->statusKepegawaianService->getStatusKepegawaianProdi($idFakultas, $idThnAjaran);
            return response()->json([
                'status' => 'success',
                'data' => $data
            ]);
    ...
    {
        try {
            $data = $this->statusKepegawaianService->getTahunAjaranList();
            return response()->json([
                'status' => 'success',
                'data' => $data
            ]);
    ...
    {
        try {
            $data = $this->statusKepegawaianService->getFakultasList();
            return response()->json([
                'status' => 'success',
                'data' => $data
            ]);
    ...
    public function getProdiList(Request $request)
    {
        try {
            $idFakultas = $request->query('fakultas_id');
            $data = $this->statusKepegawaianService->getProdiListByFakultas($idFakultas);
            return response()->json([
                'status' => 'success',
                'data' => $data
            ]);
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getStatusKepegawaianFakultasHistorical(Request $request)
    {
        try {
            ...
            $data = $this->statusKepegawaianService->getStatusKepegawaianFakultasHistorical($selectedYearId, $yearsBack, $fakultasId);
            return response()->json([
                'status' => 'success',
                'data' => $data
            ]);
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function getStatusKepegawaianProdiHistorical(Request $request, $fakultasId)
    {
        try {
            $selectedYearId = $request->query('tahun_ajaran');
            $yearsBack = (int) $request->query('years_back', 5);
            ...
            $data = $this->statusKepegawaianService->getStatusKepegawaianProdiHistorical($fakultasId, $selectedYearId, $yearsBack, $prodiId);
            return response()->json([
                'status' => 'success',
                'data' => $data
            ]);
