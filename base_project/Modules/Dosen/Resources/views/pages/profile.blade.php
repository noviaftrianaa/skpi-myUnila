        ...
        <div class="row">
            <div class="col-md-3 border-right line">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5"
                    ...
                    <span class="font-weight-bold">{{ $dosen_profile['profile']['Nama'] }}</span><span
                        class="text-black-50">{{ $dosen_profile['kontak']['Email'] }}</span><span> </span>
                </div>
                    ...
                    <div class="card p-3">
                        ...
                        <div class="table-responsive p-0 line-top">
                            <table class="table align-items-center justify-content-center mb-0">
                                ...
                                <tbody>
                                    @foreach ($dosen_profile['profile'] as $key => $value)
                                        @if ($key == 'Nama')
                                            @continue
                                        @endif
                                        <tr>
                    ...
                    <div class="card p-3">
                        ...
                        <div class="table-responsive p-0 line-top">
                            <table class="table align-items-center justify-content-center mb-0">
                                ...
                                <tbody>
                                    @foreach ($dosen_profile['kependudukan'] as $key => $value)
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2">
                                                    <div class="my-auto">
                    ...
                    <div class="card p-3">
                        ...
                        <div class="table-responsive p-0 line-top">
                            <table class="table align-items-center justify-content-center mb-0">
                                ...
                                <tbody>
                                    @foreach ($dosen_profile['keluarga'] as $key => $value)
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2">
                                                    <div class="my-auto">
