...
@section('content')
    <div class="container-fluid py-4">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">TAHUN AJARAN</p>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">SERTIFIKASI</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        3
                                    </h5>
                                </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">PENELITIAN</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        11
                                    </h5>
                                </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">PENGABDIAN</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        9
                                    </h5>
                                </div>
        ...
        <div class="row mt-4">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    <h5 class="font-weight-bolder float-right d-flex justify-content-center">Tegar Wisnu
                                        Pambudi</h5>
                                                    ...
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-xs">0027116202</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-xs">196211271986031003</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-xs">Pembina Utama Muda - IV/c
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-xs">Lektor</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-xs">Pertanian</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-xs">S1 Kehutanan</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="mb-0 text-sm">{{ $absensi }}</h6>
                                        </td>
                                ...
                                <div class="col-lg-6 col-7">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li><a class="dropdown-item" href="javascript:;">2021/2022</a></li>
                                            <li><a class="dropdown-item" href="javascript:;">2020/2021</a></li>
                                            <li><a class="dropdown-item" href="javascript:;">2019/2020</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row my-4 shadow-blur">
                <div class="col">
                    <div class="card">
                        <div class="p-4">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex px-2 py-1">
                                                                    <div class="d-flex flex-column justify-content-center">
                                                                        <h6 class="mb-0 text-sm">Identifikasi Tumbuhan
                                                                            Sumber Pakan Lebah
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex px-2 py-1">
                                                                    <div class="d-flex flex-column justify-content-center">
                                                                        <h6 class="mb-0 text-sm">Identifikasi Kerusakan
                                                                            Tegakan Hutan di
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex px-2 py-1">
                                                                    <div class="d-flex flex-column justify-content-center">
                                                                        <h6 class="mb-0 text-sm"> Identifikasi Tingkat
                                                                            Kerusakan Tegakan
                                                                            Hutan di Areal Garapan Petani KPPH Talang Mulya
                                                                            Kecamatan Padang
                                                                            Cermin</h6>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="d-flex px-2 py-1">
                                                                    <div class="d-flex flex-column justify-content-center">
                                                                        <h6 class="mb-0 text-sm">Tipe Kombinasi Jenis
                                                                            Tanaman dan Hasil
                                                                            Panen pada Areal Garapan Petani dalam Kawasan
                                                                            Hutan Register 19
                                                                            Provinsi Lampung</h6>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="d-flex px-2 py-1">
                                                                    <div class="d-flex flex-column justify-content-center">
                                                                        <h6 class="mb-0 text-sm">Identifikasi Tumbuhan
                                                                            Sumber Pakan
                                                                            Lebah Madu di Kecamatan Gading Rejo Kabupeten
                                                                            Pringsewu</h6>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="d-flex px-2 py-1">
                                                                    <div class="d-flex flex-column justify-content-center">
                                                                        <h6 class="mb-0 text-sm">Identifikasi Kerusakan
                                                                            Tegakan Hutan
                                                                            di Areal Garapan Petani KPPH Kuyung Bawah dalam
                                                                            Tahura Wan
                                                                            Abdul Rachman</h6>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="d-flex px-2 py-1">
                                                                    <div class="d-flex flex-column justify-content-center">
                                                                        <h6 class="mb-0 text-sm">Tingkat Kesamaan
                                                                            Komposisi Tegakan
                                                                            Hutan Antargarapan Petani KPPH Talangmulya</h6>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
