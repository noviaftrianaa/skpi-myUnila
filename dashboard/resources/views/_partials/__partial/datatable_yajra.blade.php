...
{{--<link href="{{asset('node_modules/datatables/media/css/dataTables.bootstrap.css')}}" rel="stylesheet">--}}
...
{{--<script type="text/javascript" src="{{ asset('node_modules/datatables/media/js/dataTables.bootstrap.min.js')}}"></script>--}}
