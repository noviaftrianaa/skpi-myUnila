...
<head>
  ...
  <title>@hasSection('title') @yield('title') @else
    {{ config('variables.templateName') ? config('variables.templateName') : 'TemplateName' }} -
    {{ config('variables.templateSuffix') ? config('variables.templateSuffix') : 'TemplateSuffix' }} @endif
  </title>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/x-icon" href="{{ asset('/images/logo-unila.png') }}" />
