<script type="text/javascript">
        ...
        const fv = FormValidation.formValidation(addNewUserForm, {
            plugins: {
                ...
                submitButton: new FormValidation
                    .plugins
                    .SubmitButton(),
                // Submit the form when all fields are valid defaultSubmit: new
    ...
    function DrillDownFakultas(id, fak) {
        TablePointIku(id, fak)
    }

    function DrillDownProdi(id) {
        TablePointIku(id)
    }

    // datatable (jquery)
    function TablePointIku(id, fak) {
            ...
            $.ajax({
                ...
                "success": function (data) {
                    dt_basic = dt_basic_table.DataTable({
                        bDestroy: true, data: data.data, // Get the data object
                        columns: [
                          {
                              data: ''
                          }, {
                            ...
                            },
                            {
                                ...
                                render: function (data, type, row) {
                                    if (row.id_jns_sms == '1') {
                                        ...
                                        return '<a href="#" onclick="DrillDownProdi(`' + row.id_sms + '`)">' + data + '</a>';
                                    }
