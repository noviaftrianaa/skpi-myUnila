...
@section('title', 'Indikator Kinerja Utama - IKU 6 Universitas Lampung')
...
@section('page-script')
  @include('content.main.iku.iku-6.function')
@endsection
  ...
  <div class="col-12 mb-4">
    <div class="bs-stepper wizard-vertical vertical mt-2">
        <div class="bs-stepper-header">
            ...
            <div class="line"></div>
            <a class="step crossed select-iku zoom" href="{{ route('main-iku6') }}">
            <button type="button" class="step-trigger">
                    ...
                    <div class="col-sm-6 col-lg-3 mb-4">
                        <div class="card card-border-shadow-primary">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-2 pb-1">
                                    <span class="avatar-initial rounded bg-label-primary p-1">
                                        <h4 class="ms-1 mb-0" id="total_valid">0</h4>
                                    </span>
                                </div>
                                <p class="mb-1">Total Kerjasama Valid</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3 mb-4">
                        <div class="card card-border-shadow-primary">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-2 pb-1">
                                    <span class="avatar-initial rounded bg-label-primary p-1">
                                        <h4 class="ms-1 mb-0" id="total_prodi">0</h4>
                                    </span>
                                </div>
                                <p class="mb-1">Total Prodi</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3 mb-4">
    ...
    <table class="datatables-point table table-bordered">
      <thead style="background-color:#ECF3FF">
        <tr>
          ...
          <th width ="10%">Total Kerjasama</th>
          <th width ="15%">Total Kerjasama Valid</th>
...
@include('content.main.iku.iku-6.detail')
