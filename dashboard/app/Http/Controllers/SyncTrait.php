        ...
        if ("pdrd" == $skema) {
            if ("publikasi" == $table) {
                            ...
                            ->fill(
                                $reg_sdm_baru->prepare([
                                    ...
                                    "id_sms" =>
                                        $detail_data_penugasan["id_unit_kerja"],
                                    "no_srt_tgs" =>
                                        $detail_data_penugasan["surat_tugas"],
                                    "tgl_srt_tgs" =>
                                        $detail_data_penugasan[
                                            "tanggal_surat_tugas"
                                        ],
                ...
                $jenis_sms = DB::table("ref.jenis_sms")
                    ->where("id_jns_sms", $detail_sms["id_jenis_unit"])
                    ->first();
                ...
                if (is_null($cek_sms)) {
                    ...
                    $simpan_sms
                        ->fill(
                            $simpan_sms->prepare([
                                ...
                                "id_lemb_non_sp" =>
                                    $detail_sms["id_lembaga_penerbit"],
                                ...
                                "sk_selenggara" =>
                                    $detail_sms["sk_penyelenggara"],
                                "tgl_sk_selenggara" =>
                                    $detail_sms["tanggal_sk_penyelenggara"],
                                "tmt_sk_selenggara" =>
                                    $detail_sms[
                                        "terhitung_mulai_tanggal_penyelenggara"
                                    ],
                                "tst_sk_selenggara" =>
                                    $detail_sms[
                                        "terhitung_sampai_tanggal_penyelenggara"
                                    ],
                    ...
                    if (
                        strtotime($detail_sms["waktu_data_update"]) >
                        ...
                        $cek_sms
                            ->fill(
                                $cek_sms->prepare([
                                    ...
                                    "smt_mulai" =>
                                        $detail_sms["semester_mulai"],
                                    "kode_prodi" => $detail_sms["kode_unit"],
                                    "sks_lulus" => $detail_sms["sks_lulus"],
                                    "gelar_lulusan" =>
                                        $detail_sms["gelar_lulusan"],
                                    "tgl_tutup" => $detail_sms["tanggal_tutup"],
                                    "stat_prodi" => $detail_sms["status_unit"],
                                    "tgl_berdiri" =>
                                        $detail_sms["tanggal_berdiri"],
                                    "sk_selenggara" =>
                                        $detail_sms["sk_penyelenggara"],
                                    "tgl_sk_selenggara" =>
                                        $detail_sms["tanggal_sk_penyelenggara"],
