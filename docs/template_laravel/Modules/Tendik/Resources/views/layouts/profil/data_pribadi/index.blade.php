...
@section('css')
    <style>
        ...
        .line {
            border-right: 0.1px solid #cb0c9f;
        }

        .line-top {
            border-top: 0.1px solid #cb0c9f;
        }

        .line-bottom {
            border-bottom: 0.1px solid #cb0c9f;
        }
        ...
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5"
                    ...
                    <span class="font-weight-bold">{{ $data_pribadi['profile']['Nama'] }}</span><span
                        class="text-black-50">{{ $data_pribadi['kontak']['Email'] }}</span><span> </span>
                </div>
                    ...
                    <div class="card p-3">
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center justify-content-center mb-0">
                                ...
                                <tbody>
                                    @foreach ($data_pribadi['kependudukan'] as $key => $value)
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2">
                                                    <div class="my-auto">
                    ...
                    <div class="card p-3">
                        ...
                        <div class="card-body p-3">
                            <div class="timeline timeline-one-side">
                                @foreach ($data_pribadi['keilmuan'] as $key => $values)
