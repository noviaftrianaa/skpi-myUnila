            ...
            foreach ($get_data AS $each_data) {
                ...
                if (is_null($carimhs)) {
                    DB::table('pdrd.peserta_didik')->insert([
                        ...
                        'tgl_lahir_wali'    => is_null($each_data['tanggal_lahir_wali'])?null:date('Y-m-d',strtotime($each_data['tanggal_lahir_wali'])),
                        ...
                        'tgl_lahir_ibu'     => is_null($each_data['tanggal_lahir_ibu'])?null:date('Y-m-d',strtotime($each_data['tanggal_lahir_ibu'])),
                        ...
                        'tgl_lahir_ayah'    => is_null($each_data['tanggal_lahir_ayah'])?null:date('Y-m-d',strtotime($each_data['tanggal_lahir_ayah'])),
