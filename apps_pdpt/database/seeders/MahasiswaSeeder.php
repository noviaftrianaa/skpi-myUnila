                ...
                if (is_null($carireg)) {
                    ...
                    if (!is_null($carireg->id_jns_keluar)) {
                        ...
                        DB::table('pdrd.reg_pd')->where('id_reg_pd',$carireg->id_reg_pd)->update([
                            'id_jns_keluar'     => $get_data_lulus_do['id_jenis_keluar'],
                            'tgl_keluar'        => $get_data_reg[0]['tanggal_keluar'],
                            'ket'               => $get_data_reg[0]['keterangan'],
                            'sk_yudisium'       => $get_data_reg[0]['nomor_sk_yudisium'],
                            'tgl_sk_yudisium'   => $get_data_reg[0]['tanggal_sk_yudisium'],
                            'ipk'               => $get_data_reg[0]['ipk'],
                            'no_seri_ijazah'    => $get_data_reg[0]['nomor_ijazah'],
                            'jalur_skripsi'     => $get_data_reg[0]['jalur_skripsi'],
                            'judul_skripsi'     => $get_data_reg[0]['judul_skripsi'],
                            'bln_awal_bimbingan'=> $get_data_reg[0]['bulan_awal_bimbingan'],
                            'bln_akhir_bimbingan'=> $get_data_reg[0]['bulan_akhir_bimbingan'],
                            'asal_data_ijazah'  => $get_data_reg[0]['asal_ijazah'],
                            'last_update'       => currDateTime(),
                            'id_updater'        => '443701e4-e814-48f3-9528-251bccee8af1',
                        ]);
                    } else {
