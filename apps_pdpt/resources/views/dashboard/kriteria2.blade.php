    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #1e73be">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <a class="text-color:white"> Kriteria Standar 2</a>
            </div>
        </div>
    </nav>
    <!-- Main content -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="Kerjasama-Pendidikan-tab" data-toggle="pill"
                                            href="#Kerjasama-Pendidikan" role="tab" aria-controls="Kerjasama-Pendidikan"
                                            aria-selected="true">Kerjasama Pendidikan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="Kerjasama-Penelitian-tab" data-toggle="pill"
                                            href="#Kerjasama-Penelitian" role="tab" aria-controls="pills-contact"
                                            aria-selected="false">Kerjasama Penelitian</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="Kerjasama-Pengabdian-tab" data-toggle="pill"
                                            href="#Kerjasama-Pengabdian" role="tab" aria-controls="Kerjasama-Pengabdian"
                                            aria-selected="false">Kerjasama Pengabdian Kepada Masyarakat</a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="Kerjasama-Pendidikan" role="tabpanel"
                                        aria-labelledby="Kerjasama-Pendidikan-tab">
                                        <style type="text/css">
                                            .tg {
                                        ...
                                        <table class="tg table-responsive table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="tg-c3ow" rowspan="2">Judul Kegiatan</th>
                                    ...
                                    <div class="tab-pane fade" id="Kerjasama-Penelitian" role="tabpanel"
                                        aria-labelledby="Kerjasama-Penelitian-tab">
                                        <table class="tg table-responsive table-striped">
                                            <thead>
                                                <tr>
                                                    <th class="tg-c3ow" rowspan="2">No</th>
                                    ...
                                    <div class="tab-pane fade" id="Kerjasama-Pengabdian" role="tabpanel"
                                        aria-labelledby="Kerjasama-Pengabdian-tab">
                                        <table class="tg table-responsive table-striped">
                                            <thead>
                                                <tr>
                                                    <th class="tg-c3ow" rowspan="2">No</th>
