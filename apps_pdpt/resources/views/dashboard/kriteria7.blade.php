                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="mahasiswa-tab" data-toggle="pill"
                                            href="#mahasiswa" role="tab" aria-controls="mahasiswa"
                                            aria-selected="false">Penelitian DTPS yang melibatkan mahasiswa </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="tesis-tab" data-toggle="pill" href="#tesis"
                                            role="tab" aria-controls="tesis" aria-selected="false">Penelitian DTPS yang
                                            menjadi rujukan tema tesis </a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="tesis" role="tabpanel"
