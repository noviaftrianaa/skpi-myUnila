...
@push('js')
    <script>
        ...
        function Iku1Fakultas() {
            ...
            drill = 1;
            Iku1Chart(y_title, x_data_yes, x_data_no);
                            ...
                            events: {
                                click: function(event) {
                                    if (drill == 1) {
                                        ...
                                        let id_prodi = dataIku1[fak]['DRILL'][event.point.category]['DATA']['y_id'];
                                        $("#txt1_modal").html(
