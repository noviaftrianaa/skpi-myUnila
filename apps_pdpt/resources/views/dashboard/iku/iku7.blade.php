        ...
        <div class="col">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">IKU 7: Kelas yang Kolaboratif dan Partisipatif</h3>
                        ...
                        <div class="col">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-info" onclick="Iku7Data(0)">FILTER</button>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-6">
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    ...
                                    <p>Mata Kuliah Memenuhi IKU 7</p>
                                </div>
                                <div class="icon">
                        ...
                        <div class="col-lg-4 col-6">
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    ...
                                    <p>Mata Kuliah Tidak Memenuhi IKU 7</p>
                                </div>
                                <div class="icon">
                        ...
                        <div class="col-lg-6 col-6">
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    ...
                                    <p>Presentase Pencapaian IKU 7</p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-stats-bars"></i>
                                </div>
                        ...
                        <div class="col-lg-6 col-6">
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    ...
                                    <p>Delta Terhadap Gold Standar IKU 7</p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-person-add"></i>
                                </div>
