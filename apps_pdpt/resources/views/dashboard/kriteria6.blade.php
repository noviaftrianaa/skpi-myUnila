                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" id="kurikulum-tab" data-toggle="pill"
                                            href="#kurikulum" role="tab" aria-controls="kurikulum"
                                            aria-selected="true">Kurikulum, capaian pembelajaran, dan rencana
                                            pembelajaran</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="Intergrasi-tab" data-toggle="pill"
                                            href="#Intergrasi" role="tab" aria-controls="pills-contact"
                                            aria-selected="false">Intergrasi kegiatan penelitian/ PKM dalam
                                            Pembelajaran</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="Kepuasan-tab" data-toggle="pill"
                                            href="#Kepuasan" role="tab" aria-controls="pills-profile"
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <table class="tg table-responsive table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="tg-0lax" rowspan="2">Dokumen Rencanan Pembelajaran
                                                    </th>
                                    ...
                                    <div class="tab-pane fade" id="Intergrasi" role="tabpanel"
                                        aria-labelledby="Intergrasi-tab">
                                        <table class="tg table-responsive table-striped">
                                            <thead>
                                                <tr>
                                        ...
                                        <table class="tg table-responsive table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="tg-0lax" colspan="4">Tingkat Kepuasan Mahasiswa
                                                    </th>
                                                    <th class="tg-0lax" rowspan="2">Rencana Tindak Lanjut oleh
                                                        UPPS/PS</th>
                                                </tr>
                                                <tr>
