...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #1e73be">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <a style='color'> Detail Standar 1</a>
        </div>
    </div>
</nav>
<!-- Main content -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                  <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Kerjasama Pendidikan</a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Kerjasama Penelitian</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Kerjasama Pengabdian Kepada Masyarakat</a>
                                  </li>
                              </ul>
                              ...
                              <style type="text/css">
                                ...
                                <thead>
                                  <tr>
                                    ...
                                    <th class="tg-0pky">Nama Dosen</th>
                                    <th class="tg-0pky">Tema Penelitian sesuai Roadmap </th>
                                    <th class="tg-0pky">Nama Mahasiswa</th>
                                    <th class="tg-0pky">Judul Kegiatan</th>
                                    <th class="tg-0pky">Tahun (YYYY)</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  <tr>
