    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #1e73be">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <a style='color'> Kriteria Standar 3</a>
            </div>
        </div>
    </nav>
    <!-- Main content -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" id="seleksi-mahasiswa-tab" data-toggle="pill"
                                            href="#seleksi-mahasiswa" role="tab" aria-controls="seleksi-mahasiswa"
                                            aria-selected="true">Seleksi Mahasiswa Baru</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="mahasiswa-asing-tab" data-toggle="pill"
                                            href="#mahasiswa-asing" role="tab" aria-controls="mahasiswa-asing"
                                            aria-selected="false">Mahasiswa Asing</a>
                                    </li>

                                </ul>
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="seleksi-mahasiswa" role="tabpanel"
                                        aria-labelledby="seleksi-mahasiswa-tab">
                                        <style type="text/css">
                                            .tg {
                                        ...
                                        <table class="tg">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="tg-c3ow" rowspan="2">Manfaat bagi PS yang Diakreditasi
                                                    </th>
                                                    <th class="tg-c3ow" rowspan="2">Waktu dan Durasi</th>
                                                    <th class="tg-c3ow" rowspan="2">Bukti Kerjasama</th>
                                                    <th class="tg-c3ow" rowspan="2">Tahun Berakhirnya Bekerjasama (yyyy)
                                                    </th>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="tab-pane fade" id="mahasiswa-asing" role="tabpanel"
                                        aria-labelledby="mahasiswa-asing-tab">
                                        <table class="tg">
                                            <thead>
                                                <tr>
                                                    <th class="tg-0lax" rowspan="2">No </th>
                                                    <th class="tg-baqh" rowspan="2">Program Studi</th>
                                                    <th class="tg-baqh" colspan="3">Jumlah Mahasiswa Aktif</th>
                                                    <th class="tg-baqh" colspan="3">Jumlah Mahasiswa Asing Paruh Waktu
                                                        (Full-time)</th>
                                                    <th class="tg-baqh" colspan="3">Jumlah Mahasiswa Asing Paruh Waktu
                                                        (Part-time)</th>
                                                </tr>
