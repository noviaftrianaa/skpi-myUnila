...
@include('home.wr.wakil_rektor_1.litabmas.pengabdian.report-pt-chart')
...
@section('content')
        ...
        <div class="row mb-3">
            <div class="col">
                <div class="input-group">
                    <select id="thn_pengabdian" class="form-control mr-2">
                        @foreach ($pengabdianYear as $th)
                            <option {{ $th->a_periode_aktif == 1 ? 'selected' : '' }} value="{{ $th->id_thn_ajaran }}">
                                Data Pengabdian Tahun {{ $th->id_thn_ajaran }}</option>
                        @endforeach
                    </select>
                    ...
                    <div id="chart" class="tab-pane fade show active" role="tabpanel" aria-labelledby="chart-tab">
                        ...
                        <div class="card-body" id="chartEmptyState">
                            <div class="col-12 text-center">
                                ...
                                <h2>Belum Ada Data Pengabdian</h2>
                            </div>
                        </div>
                    </div>
    ...
    <div id="chartPengabdianDetail" class="modal fade" role="dialog" aria-hidden="true">
