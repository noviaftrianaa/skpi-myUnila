                ...
                <div class="input-group">
                    <span class="mr-2 p-2"> <strong>Tahun IKU</strong></span>
                     ...
                     <div class="input-group-append">
                         <button class="btn btn-sm py-0 bg-white mr-2" onclick="Iku5Data(0)"><i class="fas fa-filter"></i> Filter</button>
                         <button class="btn btn-sm py-0 bg-white mr-2" onclick="DownloadIku5(1)"><i class="fas fa-download"></i> Excel</button>
...
<div class="modal fade" id="rumusIku1Modal" tabindex="-1" role="dialog" aria-labelledby="rumusIku5ModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="rumusIku5ModalLabel">Formula IKU 5</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
        </div>
        <div class="modal-body">
            <img src="{{ asset('images/rumus-iku-5.png') }}" class="img-fluid">
        </div>
    </div>
    </div>
</div>
