    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 mb-4">
                <div class="card h-100">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-info-circle"></i> Masa Berlaku</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                <tbody>
                                    {!! tableRow('Status', $profil_dosen->nm_sdm) !!}
                                    {!! tableRow('Tanggal Awal', $profil_dosen->nidn) !!}
                                    {!! tableRow('Tanggal Berakhir', $profil_dosen->nip) !!}
            ...
            <div class="col-sm-6 mb-4">
                <div class="card h-100">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-briefcase"></i> Pekerjaan</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped">
        ...
        <div class="row">
            <div class="col-sm-6 mb-4">
                <div class="card h-100">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-graduation-cap"></i> Riwayat Pendidikan Formal</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped">
            ...
            <div class="col-sm-6 mb-4">
                <div class="card h-100">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-history"></i> Riwayat Kepangkatan</h3>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-6 mb-4">
                <div class="card h-100">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-briefcase"></i> Riwayat Fungsional</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped">
            ...
            <div class="col-sm-6 mb-4">
                <div class="card h-100">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-tasks"></i> Riwayat Struktural</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped">
            ...
            <div class="col-sm-6 mb-4">
                <div class="card h-100">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-tasks"></i> Riwayat Tugas Tambahan</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach ($rwy_tgs_tmbhn as $no_struk => $each_rwy_tgs_tmbhn)
                                        <tr>
                                            <td>{{ $each_rwy_tgs_tmbhn->nm_jab_tgs }}</td>
                                            <td>{{ $each_rwy_tgs_tmbhn->jml_jam }}</td>
                                            <td>{{ $each_rwy_tgs_tmbhn->nm_kat }}</td>
                                            <td>{{ $each_rwy_tgs_tmbhn->sk_tugas_tambah }}</td>
                                            <td>{{ tglIndonesia($each_rwy_tgs_tmbhn->tmt_sk_tambah) }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
            ...
            <div class="col-sm-6 mb-4">
                <div class="card h-100">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-tasks"></i> Riwayat Pekerjaan</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach ($rwy_krja as $no_struk => $each_rwy_krja)
                                        <tr>
                                            <td>{{ $each_rwy_krja->nm_pekerjaan }}</td>
                                            <td>{{ $each_rwy_krja->nm_jabatan }}</td>
                                            <td>{{ $each_rwy_krja->instansi }}</td>
                                            <td>{{ tglIndonesia($each_rwy_krja->mulai_bekerja) }}</td>
                                            <td>{{ tglIndonesia($each_rwy_krja->selesai_bekerja) }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
