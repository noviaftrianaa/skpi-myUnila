...
class TemplateDokCommand extends Command
{
    protected $signature = 'generate:dok';

    protected $description = 'Create Dok Controller And Model From Template';
    ...
    public function handle()
    {
        ...
        foreach ($getTable as $t) {
            ...
            foreach ($data as $key => $value) {
                ...
                $DirPath = app_path() . DIRECTORY_SEPARATOR . 'Models' . DIRECTORY_SEPARATOR . 'PDUT' . DIRECTORY_SEPARATOR . 'Dok' . DIRECTORY_SEPARATOR;
            ...
            if ($createModel == 1) {
                ...
                $controllerNamePath = $DirPath . "DokController.php";
