...
class TemplatePdrdCommand extends Command
{
    protected $signature = 'make:pdrd';

    protected $description = 'Create Pdrd Controller From Template';
    ...
    public function handle()
    {
        ...
        foreach ($getTable as $t) {
            ...
            $templateModel = "";
            ...
            foreach ($data as $key => $value) {
                ...
                $DirPath = app_path() . DIRECTORY_SEPARATOR . 'Models' . DIRECTORY_SEPARATOR . 'PDUT' . DIRECTORY_SEPARATOR . 'Pdrd' . DIRECTORY_SEPARATOR;
            ...
            if ($createModel == 1) {
                ...
                $controllerNamePath = $DirPath . "PdrdController.php";
