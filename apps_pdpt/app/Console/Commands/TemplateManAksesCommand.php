...
class TemplateManAksesCommand extends Command
{
    protected $signature = 'generate:man_akses';

    protected $description = 'Create man_akses Controller And Model From Template';
    ...
    public function handle()
    {
        ...
        foreach ($getTable as $t) {
            ...
            foreach ($data as $key => $value) {
                ...
                $DirPath = app_path() . DIRECTORY_SEPARATOR . 'Models' . DIRECTORY_SEPARATOR . 'PDUT' . DIRECTORY_SEPARATOR . 'ManAkses' . DIRECTORY_SEPARATOR;
            ...
            if ($createModel == 1) {
                ...
                $controllerNamePath = $DirPath . "ManAksesController.php";
