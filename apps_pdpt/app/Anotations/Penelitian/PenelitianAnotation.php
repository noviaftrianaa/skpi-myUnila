 ...
 * tags={"Penelitian"},
 * summary="Mendapatkan Daftar Penelitian Berdasarkan ID",
 * description="Menampilkan Daftar Penelitian Berdasarkan ID",
...
/**
 * @OA\Put(
 * path="/penelitian/update/",
 * operationId="updatePenelitian",
 * tags={"Penelitian"},
 * summary="Update Penelitian Berdasarkan ID",
 * description="Mengupdate Penelitian Berdasarkan ID",
 * @OA\RequestBody(
 * @OA\MediaType(
 * mediaType="applicatin/json",
 * @OA\Schema(
...
/**
 * @OA\Delete (
 *      path="/penelitian/delete",
 *      operationId="deletePenelitian",
 *      tags={"Penelitian"},
