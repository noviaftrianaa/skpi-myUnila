...
/**
 * @OA\Get(
 *       path="/lembaga/daftar_satuan_pendidikan",
 *       tags={"Lembaga"},
 *       summary="Dapatkan daftar satuan pendidikan",
 *       description="Menampilkan daftar data satuan pendidikan",
 *       operationId="getSatuanPendidikan",
 *       @OA\Parameter(
 *          name="page",
 *          description="",
 *          example="1",
