 ...
 *      description="Mengubah Peserta MBKM",
 *      @OA\JsonContent(
 *          required={"id_daftar_mbkm", "id_akt_mhs", "id_ang_akt_mhs", "id_reg_pd","lokasi_mbkm","a_diluar_pt","judul_akt_mhs","sk_tugas", "tgl_sk_tugas", "ket_akt","a_komunal","id_sdm","urutan_promotor"},
 *          @OA\Property(property="id_daftar_mbkm", type="string", format="text", example="Masukan id_daftar_mbkm"),
 *          @OA\Property(property="id_akt_mhs", type="string", format="text", example="Masukan id_akt_mhs"),
 *          @OA\Property(property="id_ang_akt_mhs", type="string", format="text", example="Masukan id_ang_akt_mhs"),
 *          @OA\Property(property="lokasi_mbkm", type="string", format="text", example="Universitas Indonesia"),
 *          @OA\Property(property="a_diluar_pt", type="number", format="number", example="1"),
 *          @OA\Property(property="judul_akt_mhs", type="string", format="text", example="Asistensi Mengajar di Satuan Pendidikan"),
 *          @OA\Property(property="sk_tugas", type="string", format="text", example="File SK tugas"),
 ...
 *      @OA\Parameter( name="id_ang_akt_mhs", description="masukan id_ang_akt_mhs", example="Masukan id_ang_akt_mhs mbkm", required=true, in="query",
