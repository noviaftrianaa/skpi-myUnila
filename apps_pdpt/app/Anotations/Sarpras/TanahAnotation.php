...
/**
 * @OA\Get(
 *     path="/sarpras/tanah/daftar",
 *     tags={"Sarana dan Prasarana"},
 *     summary="Mendapatkan Daftar Sarpras Tanah",
 *     description="Menampilkan Daftar Sarpras Tanah",
 *     operationId="daftarSarprasTanah",
 *     @OA\Parameter(
 *          name="page",
 *          description="",
 *          example="1",
...
/**
 * @OA\Post (
 *      path="/sarpras/tanah/tambah",
 *      operationId="tambahSarprasTanah",
 *      tags={"Sarana dan Prasarana"},
 *      summary="Tambah Sarpras Tanah",
 *      description="Menambah Sarpras Tanah",
 *      @OA\RequestBody(
 *      required=true,
 *      @OA\JsonContent(
...
/**
 * @OA\Put (
 *      path="/sarpras/tanah/ubah",
 *      operationId="ubahSarprasAlat",
 *      tags={"Sarana dan Prasarana"},
 *      summary="Ubah Sarpras Tanah",
 *      description="Mengubah Sarpras Tanah",
 *      @OA\RequestBody(
 *      required=true,
 *      @OA\JsonContent(
...
/**
 * @OA\Delete (
 *      path="/sarpras/tanah/hapus",
 *      operationId="hapusSarprasAlat",
 *      tags={"Sarana dan Prasarana"},
 *      summary="Hapus Sarpras Alat",
 *      description="Menghapus Sarpras Tanah",
 *      @OA\RequestBody(
 *      required=true,
 *      @OA\JsonContent(
 *          required={"id_tanah"},
 *          @OA\Property(property="id_tanah", type="string", format="text", example="")
 *          ),
 *      ),
 *      @OA\Response(
 *          response=200,
