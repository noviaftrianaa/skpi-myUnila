...
/**
 * @OA\Get(
 *     path="/sarpras/bangunan/daftar",
 *     tags={"Sarana dan Prasarana"},
 *     summary="Mendapatkan Daftar Sarpras Bangunan",
 *     description="Menampilkan Daftar Sarpras Bangunan",
 *     operationId="daftarSarprasBangunan",
 *     @OA\Parameter(
 *          name="page",
 *          description="",
 *          example="1",
...
/**
 * @OA\Post (
 *      path="/sarpras/bangunan/tambah",
 *      operationId="tambahSarprasBangunan",
 *      tags={"Sarana dan Prasarana"},
 *      summary="Tambah Sarpras Bangunan",
 *      description="Menambah Sarpras Bangunan",
 *      @OA\RequestBody(
 *      required=true,
 *      @OA\JsonContent(
...
/**
 * @OA\Put (
 *      path="/sarpras/bangunan/ubah",
 *      operationId="ubahSarprasAlat",
 *      tags={"Sarana dan Prasarana"},
 *      summary="Ubah Sarpras Bangunan",
 *      description="Mengubah Sarpras Bangunan",
 *      @OA\RequestBody(
 *      required=true,
 *      @OA\JsonContent(
...
/**
 * @OA\Delete (
 *      path="/sarpras/bangunan/hapus",
 *      operationId="hapusSarprasAlat",
 *      tags={"Sarana dan Prasarana"},
 *      summary="Hapus Sarpras Alat",
 *      description="Menghapus Sarpras Bangunan",
 *      @OA\RequestBody(
 *      required=true,
 *      @OA\JsonContent(
 *          required={"id_alat"},
