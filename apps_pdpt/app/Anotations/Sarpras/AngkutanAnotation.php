...
/**
 * @OA\Get(
 *     path="/sarpras/angkutan/daftar",
 *     tags={"Sarana dan Prasarana"},
 *     summary="Mendapatkan Daftar Sarpras Angkutan",
 *     description="Menampilkan Daftar Sarpras Angkutan",
 *     operationId="daftarSarprasAngkutan",
 *     @OA\Parameter(
 *          name="page",
 *          description="",
 *          example="1",
...
/**
 * @OA\Post (
 *      path="/sarpras/angkutan/tambah",
 *      operationId="tambahSarprasAngkutan",
 *      tags={"Sarana dan Prasarana"},
 *      summary="Tambah Sarpras Angkutan",
 *      description="Menambah Sarpras Angkutan",
 *      @OA\RequestBody(
 *      required=true,
 *      @OA\JsonContent(
...
/**
 * @OA\Put (
 *      path="/sarpras/angkutan/ubah",
 *      operationId="ubahSarprasAlat",
 *      tags={"Sarana dan Prasarana"},
 *      summary="Ubah Sarpras Angkutan",
 *      description="Mengubah Sarpras Angkutan",
 *      @OA\RequestBody(
 *      required=true,
 *      @OA\JsonContent(
...
/**
 * @OA\Delete (
 *      path="/sarpras/angkutan/hapus",
 *      operationId="hapusSarprasAlat",
 *      tags={"Sarana dan Prasarana"},
 *      summary="Hapus Sarpras Alat",
 *      description="Menghapus Sarpras Angkutan",
 *      @OA\RequestBody(
 *      required=true,
 *      @OA\JsonContent(
 *          required={"id_alat"},
