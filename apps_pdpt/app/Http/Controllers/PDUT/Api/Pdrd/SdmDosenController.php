...
class SdmDosenController extends Controller
{
    ...
    public function detail()
    {
        ...
        try {
            ...
            $sdms = DB::select($query);
            if (empty($sdms)) {
                return WrapResponse(['data' => null], 'tidak ada detail dosen yang ditampilkan', FALSE);
            }
            ...
            return WrapResponse(['data' => null], 'gagal mendapatkan detail dosen', FALSE);
        }
        return WrapResponse(['data' => $data], 'detail dosen', TRUE);
    }
}
