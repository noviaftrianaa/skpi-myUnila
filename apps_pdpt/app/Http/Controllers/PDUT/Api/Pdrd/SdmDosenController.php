...
class SdmDosenController extends Controller
{
    ...
    public function list()
    {
        ...
        try {
            $query = "
                ...
                WHERE sdm.id_jns_sdm = 12 AND sdm.soft_delete = 0
            ...
            if (empty($sdms)) {
                return WrapResponse(['data' => null], 'tidak ada daftar dosen yang ditampilkan', FALSE);
            }
            ...
            return WrapResponse(['data' => null], 'gagal mendapatkan daftar dosen', FALSE);
        }
    ...
    public function listByIdProdi()
    {
        ...
        try {
            ...
            $sdms = DB::select($query);
            if (empty($sdms)) {
                return WrapResponse(array('data' => array('id_prodi' => $id_prodi)), 'daftar dosen dengan id prodi tidak ditemukan', FALSE);
            }
            ...
            return WrapResponse(array('data' => array('id_prodi' => $id_prodi)), 'gagal mendapatkan daftar dosen dengan id prodi', FALSE);
        }
        return WrapResponse(['data' => $data], 'daftar dosen dengan id prodi', TRUE);
    }
    ...
    public function detail()
    {
        ...
        try {
            ...
            $sdms = DB::select($query);
            if (empty($sdms)) {
                return WrapResponse(array('data' => array('id_sdm' => $id_sdm)), 'detail dosen dengan id sdm tidak ditemukan', FALSE);
            }
            ...
            return WrapResponse(array('data' => array('id_sdm' => $id_sdm)), 'gagal mendapatkan detail dosen dengan id sdm', FALSE);
        }
        return WrapResponse(['data' => $data], 'detail dosen dengan id sdm', TRUE);
    }
}
