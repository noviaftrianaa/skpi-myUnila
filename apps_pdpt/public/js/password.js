...
!function ($) {
    ...
    Password.prototype.init = function() {
        ...
        this.$icon = $([
            '<div class="input-group-append"><span tabindex="100" title="' + this.options.message + '" class="add-on input-group-text">',
    ...
    Password.prototype.show = function(_relatedTarget) {
        ...
        this.$text.show();
        this.$icon.find('i')
            .removeClass('icon-eye-open fa-eye')
            .addClass('icon-eye-close fa-eye-slash');
    ...
    Password.prototype.hide = function(_relatedTarget) {
        ...
        this.$text.hide();
        this.$icon.find('i')
            .removeClass('icon-eye-close fa-eye-slash')
            .addClass('icon-eye-open fa-eye');
