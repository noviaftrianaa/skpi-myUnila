 ...
 * - Error handling
 *
 * This client is used for Feeder Service API calls
 */
...
/**
 * Create Feeder API Client Instance
 */
const createFeederClient = (): AxiosInstance => {
  const instance = axios.create({
    baseURL: FEEDER_API_URL,
    timeout: API_TIMEOUT,
    headers: {
...
/**
 * Feeder API Client Instance
 */
export const feederClient = createFeederClient();
