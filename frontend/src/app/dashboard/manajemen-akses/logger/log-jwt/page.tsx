...
export default function LogJWTPage() {
  useRequireAuth();
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <Card className="max-w-lg w-full border-none shadow-xl">
          <CardBody className="p-8 text-center">
            <div className="mb-6">
              <div className="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-amber-500 to-yellow-600 flex items-center justify-center mb-4">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Fitur Log JWT sedang dalam pengembangan
              </p>
            </div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800">
                ...
                <span className="text-sm text-gray-600 dark:text-gray-300">
                  Riwayat token generation
                </span>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800">
                <FiLock className="w-5 h-5 text-green-500" />
                <span className="text-sm text-gray-600 dark:text-gray-300">
                  Token refresh & revocation logs
                </span>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800">
