      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <Card className="max-w-lg w-full border-none shadow-xl">
          <CardBody className="p-8 text-center">
            <div className="mb-6">
              <div className="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center mb-4">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Fitur Peran (Roles) sedang dalam pengembangan
              </p>
            </div>
