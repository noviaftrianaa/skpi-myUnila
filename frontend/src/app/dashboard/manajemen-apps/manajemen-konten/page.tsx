      ...
      <div className="space-y-7">
                ...
                <>
                  ...
                  <div className="p-5">
                    ...
                    {s.recent.length > 0 && (
                      <div className="space-y-1.5 mb-4 pt-3 border-t border-gray-100">
                        ...
                        {s.recent.slice(0, 3).map((k) => (
                          <Link
                            key={k.id_pengumuman}
                            href={`/dashboard/manajemen-apps/manajemen-konten/konten/${k.id_pengumuman}`}
                    ...
                    <div className="flex gap-2">
                      <Link
                        href={`/dashboard/manajemen-apps/manajemen-konten/konten?tipe=${s.tipe}`}
                      ...
                      <Link
                        href={`/dashboard/manajemen-apps/manajemen-konten/konten/baru?tipe=${s.tipe}`}
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <Link
              href="/dashboard/manajemen-apps/manajemen-konten/konten/baru"
              className="flex flex-col items-center gap-2 p-4 rounded-xl border border-gray-100 hover:bg-gray-50 transition-colors"
            >
            ...
            <Link
              href="/dashboard/manajemen-apps/manajemen-konten/konten?status=draft"
              className="flex flex-col items-center gap-2 p-4 rounded-xl border border-gray-100 hover:bg-gray-50 transition-colors"
            >
