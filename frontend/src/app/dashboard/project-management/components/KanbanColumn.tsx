...
const STATUS_STYLE: Record<
  string,
  { header: string; accent: string; dot: string; badge: string; column: string; dropHighlight: string }
> = {
  backlog: {
    ...
    dropHighlight: "ring-2 ring-slate-400/40 bg-slate-100/80 dark:bg-slate-800/80 scale-[1.01]",
  },
  todo: {
    ...
    dropHighlight: "ring-2 ring-blue-400/40 bg-blue-50/80 dark:bg-blue-950/60 scale-[1.01]",
  },
  in_progress: {
    ...
    dropHighlight: "ring-2 ring-amber-400/40 bg-amber-50/80 dark:bg-amber-950/60 scale-[1.01]",
  },
  review: {
    ...
    dropHighlight: "ring-2 ring-purple-400/40 bg-purple-50/80 dark:bg-purple-950/60 scale-[1.01]",
  },
  done: {
    ...
    dropHighlight: "ring-2 ring-emerald-400/40 bg-emerald-50/80 dark:bg-emerald-950/60 scale-[1.01]",
  },
  cancelled: {
    ...
    dropHighlight: "ring-2 ring-red-400/40 bg-red-50/80 dark:bg-red-950/60 scale-[1.01]",
  },
};
...
export default function KanbanColumn({
  ...
  // Make the column itself a drop target
  ...
  return (
    <div
      className={[
        ...
        showHighlight ? style.dropHighlight : "",
      ].join(" ")}
    >
      {/* Column header */}
          ...
          {tasks.length === 0 && (
            <div
              className={[
                ...
                showHighlight
                  ? "border-current/50 bg-white/50 dark:bg-white/5"
            ...
            >
              ...
              <span className="text-[11px] font-medium">
                {showHighlight ? "Lepas di sini" : "Drag task ke sini"}
              </span>
            </div>
          )}
        </div>
