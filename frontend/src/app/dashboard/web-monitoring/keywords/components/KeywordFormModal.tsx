                    ...
                    <>
                        ...
                        <ModalBody>
                            <div className="space-y-4">
                                <div>
                                    <label className={labelCls}>Kata Kunci / Pola Regex<span className={requiredCls}>*</span></label>
                                    <Input
                                ...
                                <div>
                                    <label className={labelCls}>Kategori<span className={requiredCls}>*</span></label>
                                    {/* @ts-ignore */}
                                    <Select
