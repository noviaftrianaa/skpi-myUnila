          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Sinkronisasi data kelas mengajar ke PDDIKTI
              </p>
            </div>
          </div>
        </div>
          ...
          <CardBody className="p-12">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                Halaman Kelas Mengajaran sedang dalam proses pengembangan.
                Fitur ini akan segera tersedia untuk membantu Anda mengelola data kelas kuliah.
              </p>
              ...
              <div className="mt-8 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg max-w-md mx-auto">
                ...
                <ul className="text-xs text-left text-gray-600 dark:text-gray-400 space-y-1">
                  <li>" Sinkronisasi data kelas perkuliahan</li>
                  <li>" Manajemen dosen pengajar</li>
                  <li>" Monitoring kelas aktif</li>
                  <li>" Export data kelas</li>
                </ul>
              </div>
            </div>
          </CardBody>
