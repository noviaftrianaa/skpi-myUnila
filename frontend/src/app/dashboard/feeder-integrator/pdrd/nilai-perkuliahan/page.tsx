...
export default function NilaiPerkuliahanPage() {
  useRequireAuth();
  const { user } = useAuth();
  ...
  return (
    <DashboardLayout
      ...
      breadcrumbs={[
        ...
        { label: "Nilai Perkuliahan", href: "/dashboard/feeder-integrator/pdrd/nilai-perkuliahan" },
      ]}
    >
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            <div className="p-3 bg-teal-100 dark:bg-teal-900/30 rounded-lg">
              <FiAward className="w-6 h-6 text-teal-600 dark:text-teal-400" />
            </div>
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Sinkronisasi data nilai perkuliahan mahasiswa ke PDDIKTI
              </p>
            </div>
          </div>
        </div>
          ...
          <CardBody className="p-12">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                Halaman Nilai Perkuliahan sedang dalam proses pengembangan.
                Fitur ini akan segera tersedia untuk membantu Anda mengelola nilai mahasiswa.
              </p>
              ...
              <div className="mt-8 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg max-w-md mx-auto">
                ...
                <ul className="text-xs text-left text-gray-600 dark:text-gray-400 space-y-1">
                  <li>" Sinkronisasi data nilai perkuliahan</li>
                  <li>" Manajemen nilai per mata kuliah</li>
                  <li>" Monitoring status nilai mahasiswa</li>
                  <li>" Export data nilai</li>
                </ul>
              </div>
            </div>
          </CardBody>
