...
export default function DosenPembimbingPage() {
  ...
  // State
  const [stats, setStats] = useState<BimbingMhsStats | null>(null);
  ...
  const fetchStats = async () => {
    try {
      ...
      const response = await bimbingMhsService.getStats();
      ...
      toast.error("Gagal memuat statistik dosen pembimbing");
    } finally {
  ...
  const handleConfirmSync = async () => {
    ...
    try {
      ...
      const response = await bimbingMhsService.sync({
      ...
      if (response.success) {
        ...
        setSyncResult({
          totalFetched: response.data?.total_fetched || 0,
          totalSynced: response.data?.total_synced || 0,
          message:
            response.data?.message ||
            response.message ||
            "Data dosen pembimbing berhasil disinkronkan",
        });
      ...
      console.error("Error syncing bimbing mhs:", error);
      setSyncStatus("error");
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Data bimbingan mahasiswa dari Neo Feeder PDDIKTI
            </p>
          </div>
          <Button
            color="primary"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <CardBody className="p-4 relative z-10">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center shadow-lg group-hover:rotate-6 transition-transform duration-300 flex-shrink-0">
                  <MdSupervisorAccount className="w-7 h-7 text-white" />
                </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {isLoadingStats ? (
                    ...
                    <>
                      <h3 className="text-3xl font-bold text-white tracking-tight leading-none mb-1">
                        {stats?.total_aktivitas?.toLocaleString() || "0"}
                      </h3>
                      <p className="text-[10px] text-purple-100/80">
                        Aktivitas yang dibimbing
                      </p>
                    </>
                  )}
                </div>
          ...
          {/* Last Sync Card */}
          <Card className="bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 border-none shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] group overflow-hidden relative">
            <div className="absolute top-0 right-0 w-24 h-24 bg-white/10 rounded-full -mr-12 -mt-12 group-hover:scale-150 transition-transform duration-500" />
            <div className="absolute bottom-0 left-0 w-20 h-20 bg-white/5 rounded-full -ml-10 -mb-10 group-hover:scale-125 transition-transform duration-700" />
            <CardBody className="p-4 relative z-10">
              <div className="flex items-center gap-4">
        ...
        <ScheduleList syncType={"bimbing_mhs" as any} />

        {/* Data Table */}
        <FeederBimbingMhsTable onFilterChange={handleFilterChange} />
      </div>
            ...
            <>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 font-normal">
                      Data Dosen Pembimbing Neo Feeder
                    </p>
                  </div>
                </div>
              </ModalHeader>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="w-full">
                        <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
                          Proses ini akan mengambil data dosen pembimbing mahasiswa terbaru dari Neo Feeder PDDIKTI dan menyimpannya ke database.
                        </p>
                        <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1 list-disc list-inside">
                          ...
                          <li>Pastikan data SDM dan Aktivitas sudah disync</li>
                        </ul>
                      </div>
                    </div>
                  </div>
              ...
              <ModalFooter className="border-t border-gray-200 dark:border-gray-700">
                ...
                <Button
                  ...
                  className="font-medium bg-gradient-to-r from-blue-600 to-indigo-600 text-white"
                >
