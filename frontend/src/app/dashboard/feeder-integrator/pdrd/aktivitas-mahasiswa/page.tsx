...
export default function AktivitasMahasiswaManagementPage() {
  useRequireAuth();
  const { user } = useAuth();
  ...
  const fetchStats = async () => {
    try {
      ...
      const response = await feederClient.get("/aktivitas-mahasiswa/stats", {
        params: { _t: Date.now() },
      });
      ...
      toast.error("Gagal memuat statistik aktivitas mahasiswa");
    } finally {
  ...
  const handleConfirmSync = async () => {
    ...
    try {
      ...
      // Add id_semester parameter (optional - if empty, sync all semesters)
      ...
      const response = await feederClient.post(
        `/aktivitas-mahasiswa/sync?${params.toString()}`
      );
      ...
      if (response.data.success) {
        ...
        setSyncResult({
          ...
          message:
            ...
            "Data aktivitas mahasiswa berhasil disinkronkan",
        });
      ...
      console.error("Error syncing aktivitas:", error);
      setSyncStatus("error");
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Data aktivitas mahasiswa terdaftar di sistem Neo Feeder PDDIKTI
            </p>
          </div>
          <Button
            color="primary"
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {isLoadingStats ? (
                    ...
                    <>
                      <h3 className="text-3xl font-bold text-white tracking-tight leading-none mb-1">
                        {stats?.total_prodi.toLocaleString() || "0"}
                      </h3>
        ...
        <ScheduleList syncType={"aktivitas_mahasiswa" as any} />

        {/* Data Table */}
        <FeederAktivitasMahasiswaTable onFilterChange={handleFilterChange} />
      </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 font-normal">
                      Data Aktivitas Mahasiswa Neo Feeder
                    </p>
                  </div>
                </div>
              </ModalHeader>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="w-full">
                        <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
                          Proses ini akan mengambil data aktivitas mahasiswa
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                        Total: {syncResult.totalRecords} data aktivitas
                      </p>
                    </div>
                  </div>
                </div>
