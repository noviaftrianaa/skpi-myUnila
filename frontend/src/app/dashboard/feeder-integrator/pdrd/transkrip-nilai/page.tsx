  ...
  return (
    <DashboardLayout
      ...
      breadcrumbs={[
        ...
        { label: "Transkrip Nilai", href: "/dashboard/feeder-integrator/pdrd/transkrip-nilai" },
      ]}
    >
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Sinkronisasi data transkrip nilai mahasiswa ke PDDIKTI
              </p>
            </div>
          </div>
        </div>
          ...
          <CardBody className="p-12">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                Halaman Transkrip Nilai sedang dalam proses pengembangan.
                Fitur ini akan segera tersedia untuk membantu Anda mengelola transkrip nilai mahasiswa.
              </p>
              ...
              <div className="mt-8 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg max-w-md mx-auto">
                ...
                <ul className="text-xs text-left text-gray-600 dark:text-gray-400 space-y-1">
                  <li>" Sinkronisasi data transkrip nilai</li>
                  <li>" Manajemen IPK mahasiswa</li>
                  <li>" Monitoring transkrip mahasiswa lulus</li>
                  <li>" Export data transkrip</li>
                </ul>
              </div>
            </div>
          </CardBody>
