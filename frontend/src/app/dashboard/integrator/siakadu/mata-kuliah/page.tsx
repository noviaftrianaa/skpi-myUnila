...
import siakaduService, { SiakaduMataKuliah, MatakuliahFilterOptions } from "@/lib/services/siakadu/siakaduService";
...
import {
  FiBook, FiRefreshCw, FiCheckCircle, FiXCircle, FiClock,
...
export default function SiakaduMataKuliahPage() {
  ...
  // Filters
  const [filterOptions, setFilterOptions] = useState<MatakuliahFilterOptions | null>(null);
  ...
  const fetchStats = useCallback(async () => {
    try {
      ...
      const response = await siakaduService.getMatakuliahStats();
  ...
  const fetchFilters = useCallback(async () => {
    try {
      const response = await siakaduService.getMatakuliahFilters();
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const response = await siakaduService.getMatakuliahList({
        page: currentPage,
        limit: rowsPerPage,
  ...
  const handleSync = async () => {
    ...
    try {
      ...
      const response = await siakaduService.syncMatakuliah(undefined, user?.name || "system");
  ...
  const getJenisMKStyle = (jenis?: string | null) => {
    ...
    if (jenis === "Peminatan") return "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400";
    if (jenis === "Kerja Praktik") return "bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400";
    if (jenis === "Praktik/Skripsi") return "bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-400";
  ...
  return (
    <DashboardLayoutWithDynamicMenu
      ...
      pageTitle="Data Mata Kuliah SIAKADU"
    >
      <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Sinkronisasi data mata kuliah dari SIAKADU
            </p>
          </div>
          <button
        ...
        {/* Scheduled Syncs */}
        <ScheduleList syncType={"siakadu_matakuliah" as any} />
            ...
            <div className="p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Data Mata Kuliah SIAKADU</p>
                </div>
              </div>
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl mb-6">
                ...
                <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1 list-disc list-inside">
                  <li>Mengambil data mata kuliah terbaru dari SIAKADU</li>
