...
import { FiArrowLeft, FiRefreshCw, FiMapPin } from "react-icons/fi";
          ...
          <CardBody className="p-8 text-center">
            <div className="flex flex-col items-center justify-center py-12">
              <div className="w-20 h-20 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center mb-6">
                <FiMapPin className="w-10 h-10 text-blue-600 dark:text-blue-400" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                Fitur Dalam Pengembangan
              </h3>
              <p className="text-gray-600 dark:text-gray-400 max-w-md mb-6">
                Halaman Penugasan/Penempatan Dosen sedang dalam tahap pengembangan.
                Fitur ini akan segera tersedia untuk melakukan sinkronisasi data penugasan
                dan penempatan dosen dari SISTER API.
              </p>
