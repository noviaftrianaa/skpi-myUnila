      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        <div className="mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Publikasi Dosen</h1>
              <p className="text-gray-600 dark:text-gray-400">Kelola dan sinkronisasi data publikasi dosen dari SISTER API</p>
            </div>
          </div>
        </div>
            ...
            <CardBody className="p-6 relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <h3 className="text-3xl font-bold text-white tracking-tight leading-none">-</h3>
            ...
            <CardBody className="p-6 relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <h3 className="text-2xl font-bold text-white tracking-tight leading-none">Coming Soon</h3>
          ...
          <CardBody className="p-8 text-center">
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-md mb-6">
                Halaman Publikasi Dosen sedang dalam tahap pengembangan. Fitur ini akan segera tersedia untuk melakukan sinkronisasi data publikasi dosen dari SISTER API.
              </p>
