...
export default function PenelitianManagementPage() {
  ...
  // State
  const [stats, setStats] = useState<PenelitianStats | null>(null);
  ...
  const fetchStats = async () => {
    try {
      ...
      const data = await sisterPenelitianService.getStats();
      setStats(data);
    } catch (error) {
      console.error("Error fetching stats:", error);
      toast.error("Gagal memuat statistik penelitian");
    } finally {
  ...
  const handleConfirmSync = async () => {
    ...
    try {
      ...
      const result = await sisterPenelitianService.syncFromSister(username);
      ...
      toast.success(`Sinkronisasi berhasil! ${result.total_litabmas} penelitian dari ${result.total_success} dosen`);
      ...
      console.error("Error syncing penelitian:", error);
      setSyncStatus("error");
      toast.error("Gagal melakukan sinkronisasi penelitian");
      setTimeout(() => {
        setShowProgressModal(false);
        setSyncProgress(0);
        setSyncStatus("idle");
  ...
  return (
    ...
    >
      <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1">
                    <p className="text-xs font-medium text-blue-100">Total Penelitian</p>
          ...
          <Card className="bg-gradient-to-br from-emerald-500 via-green-600 to-teal-600 border-none shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] group overflow-hidden relative">
            ...
            <CardBody className="p-4 relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1">
                    <p className="text-xs font-medium text-emerald-100">Penelitian Aktif</p>
                    <div className="px-2 py-0.5 rounded-full bg-white/20 backdrop-blur-sm">
        ...
        <ScheduleList syncType="penelitian" />

        {/* Data Table */}
        <SisterPenelitianTable />
      </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
                          Sistem akan melakukan sinkronisasi semua data penelitian dosen dari SISTER API.
                        </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 font-normal">
                  ...
                  {syncStatus === "success" && syncResult && `${syncResult.totalRecords} penelitian berhasil disinkronkan`}
              ...
              {syncStatus === "syncing" && (
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
                    Sedang memproses data penelitian dosen...
                  </p>
                </div>
              )}
