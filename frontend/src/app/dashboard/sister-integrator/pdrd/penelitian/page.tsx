...
export default function PenelitianManagementPage() {
  ...
  const handleConfirmSync = async () => {
    ...
    try {
      ...
      toast.error("Sync all penelitian belum tersedia. Silakan gunakan sync per dosen.");
      setSyncStatus("error");
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
                          Sinkronisasi batch untuk semua penelitian belum tersedia.
                        </p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Silakan gunakan menu <strong>Dosen</strong> untuk melakukan sync data penelitian per dosen.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {syncStatus === "error" && (
                <div className="p-4 rounded-xl bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800">
                  <p className="text-sm text-orange-700 dark:text-orange-300">
                    Sync batch untuk semua penelitian belum tersedia. Silakan gunakan menu Dosen untuk melakukan sync penelitian per dosen.
                  </p>
                </div>
              )}
            </div>
