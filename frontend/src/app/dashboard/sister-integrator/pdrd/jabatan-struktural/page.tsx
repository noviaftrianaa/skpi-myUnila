...
import { FiArrowLeft, FiRefreshCw, FiBriefcase } from "react-icons/fi";
    ...
    <DashboardLayout appName="SISTER Integrator" menuConfig={sisterIntegratorMenuConfig}>
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        <div className="mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Jabatan Struktural</h1>
            <p className="text-gray-600 dark:text-gray-400">Kelola dan sinkronisasi data jabatan struktural dosen dari SISTER API</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          {[
            { icon: FiBriefcase, title: "Total Data", value: "-", subtitle: "Belum tersinkronisasi", color: "from-blue-500 to-blue-600" },
            { icon: FiRefreshCw, title: "Sync Terakhir", value: "-", subtitle: "Belum pernah sync", color: "from-green-500 to-green-600" },
            { icon: FiBriefcase, title: "Status", value: "Coming Soon", subtitle: "Dalam pengembangan", color: "from-purple-500 to-purple-600" },
          ].map((stat, idx) => (
          ...
          <CardBody className="p-8 text-center">
            <div className="flex flex-col items-center justify-center py-12">
              <div className="w-20 h-20 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center mb-6">
                <FiBriefcase className="w-10 h-10 text-blue-600 dark:text-blue-400" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Fitur Dalam Pengembangan</h3>
              <p className="text-gray-600 dark:text-gray-400 max-w-md mb-6">
                Halaman Jabatan Struktural sedang dalam tahap pengembangan. Fitur ini akan segera tersedia untuk melakukan sinkronisasi data jabatan struktural dosen dari SISTER API.
              </p>
