...
export default function PenggunaEditModal({
  ...
  const handleAddRole = async () => {
    if (!pengguna || !newRole.id_peran) return;
    ...
    try {
      ...
      const unit = newRole.id_organisasi
        ? unitOptions.find(u => u.id_organisasi === newRole.id_organisasi)
        : null;
                ...
                <Tab key="status" title="Status Akun">
                  <div className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <div className="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg border border-gray-200 dark:border-slate-600 space-y-3">
                        <Checkbox
                          isSelected={formData.a_aktif}
                          onValueChange={(value) => handleInputChange("a_aktif", value)}
                          color="success"
                          size="sm"
                          classNames={{
                            base: "max-w-full",
                            label: "text-sm text-gray-700 dark:text-slate-300",
                          }}
                        >
                          <div>
                        ...
                        <Checkbox
                          isSelected={formData.disable}
                          onValueChange={(value) => handleInputChange("disable", value)}
                          color="danger"
                          size="sm"
                          classNames={{
                            base: "max-w-full",
                        ...
                        >
                          <div>
                            <span className="font-medium">Disable Akun</span>
                            <p className="text-xs text-gray-500 dark:text-slate-400">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            <p className="text-gray-500 dark:text-slate-400">Sumber Data</p>
                            <p className="font-medium text-gray-900 dark:text-white">
                              {pengguna.has_sso ? "SSO Radius" : "Manajemen Akses"}
                            </p>
                          </div>
                          <div>
                            <p className="text-gray-500 dark:text-slate-400">Status Saat Ini</p>
                            <Chip
                              size="sm"
                              variant="flat"
                  ...
                  <div className="space-y-4">
                    ...
                    {showAddRole && (
                      <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-4 border border-indigo-200 dark:border-indigo-800">
                        <h5 className="font-medium text-gray-900 dark:text-white mb-3">Tambah Peran Baru</h5>
                          ...
                          <div className="space-y-1.5">
                            ...
                            >
                              {unitOptions.map((unit) => (
                                <AutocompleteItem key={unit.id_organisasi} textValue={unit.nm_lemb}>
                                  {unit.nm_lemb}
                                </AutocompleteItem>
                              ))}
                            </Autocomplete>
