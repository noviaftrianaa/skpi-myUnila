        ...
        switch (selectedTipeData) {
          ...
          case "pang_gol":
            const pangGolMap: Record<string, string> = {
              "juru_muda": "Juru Muda",
              "juru_muda_tk_1": "Juru Muda Tk. I",
              "juru": "Juru",
              "juru_tk_1": "Juru Tk. I",
              "pengatur_muda": "Pengatur Muda",
              "pengatur_muda_tk_1": "Pengatur Muda Tk. I",
              "pengatur": "Pengatur",
              "pengatur_tk_1": "Pengatur Tk. I",
              "penata_muda": "Penata Muda",
              "penata_muda_tk_1": "Penata Muda Tk. I",
              "penata": "Penata",
              "penata_tk_1": "Penata Tk. I",
              "pembina": "Pembina",
              "pembina_tk_1": "Pembina Tk. I",
  ...
  const getSubtitle = () => {
    ...
    if (selectedCategory) {
      ...
      const categoryMap: Record<string, Record<string, string>> = {
        ...
        pang_gol: {
          "juru_muda": "I/a - Juru Muda",
          "juru_muda_tk_1": "I/b - Juru Muda Tk. I",
          "juru": "I/c - Juru",
          "juru_tk_1": "I/d - Juru Tk. I",
          "pengatur_muda": "II/a - Pengatur Muda",
          "pengatur_muda_tk_1": "II/b - Pengatur Muda Tk. I",
          "pengatur": "II/c - Pengatur",
          "pengatur_tk_1": "II/d - Pengatur Tk. I",
          "penata_muda": "III/a - Penata Muda",
          "penata_muda_tk_1": "III/b - Penata Muda Tk. I",
          "penata": "III/c - Penata",
          "penata_tk_1": "III/d - Penata Tk. I",
          "pembina": "IV/a - Pembina",
          "pembina_tk_1": "IV/b - Pembina Tk. I",
          "pembina_utama_muda": "IV/c - Pembina Utama Muda",
          "pembina_utama_madya": "IV/d - Pembina Utama Madya",
          "pembina_utama": "IV/e - Pembina Utama",
          "belum_pangkat_gol": "- - Belum Pangkat",
        },
      };
