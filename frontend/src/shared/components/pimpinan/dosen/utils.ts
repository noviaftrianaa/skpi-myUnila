...
export const getStats = (
  ...
  if (selectedTipeData === "pang_gol") {
    if (selectedProdi && panggolProdiList) {
      const prodi = panggolProdiList?.find((p) => p.id === selectedProdi);
      return {
        juru_muda: prodi?.juru_muda || 0,
        juru_muda_tk_1: prodi?.juru_muda_tk_1 || 0,
        juru: prodi?.juru || 0,
        juru_tk_1: prodi?.juru_tk_1 || 0,
        pengatur_muda: prodi?.pengatur_muda || 0,
        pengatur_muda_tk_1: prodi?.pengatur_muda_tk_1 || 0,
        pengatur: prodi?.pengatur || 0,
        pengatur_tk_1: prodi?.pengatur_tk_1 || 0,
        penata_muda: prodi?.penata_muda || 0,
        penata_muda_tk_1: prodi?.penata_muda_tk_1 || 0,
        penata: prodi?.penata || 0,
        penata_tk_1: prodi?.penata_tk_1 || 0,
        pembina: prodi?.pembina || 0,
        pembina_tk_1: prodi?.pembina_tk_1 || 0,
        pembina_utama_muda: prodi?.pembina_utama_muda || 0,
        pembina_utama_madya: prodi?.pembina_utama_madya || 0,
        pembina_utama: prodi?.pembina_utama || 0,
        belum_pangkat_gol: prodi?.belum_pangkat_gol || 0,
      };
    }
    ...
    if (selectedFakultas && panggolProdiList) {
      return (panggolProdiList || []).reduce(
        (sum, p) => ({
          juru_muda: sum.juru_muda + p.juru_muda,
          juru_muda_tk_1: sum.juru_muda_tk_1 + p.juru_muda_tk_1,
          juru: sum.juru + p.juru,
          juru_tk_1: sum.juru_tk_1 + p.juru_tk_1,
          pengatur_muda: sum.pengatur_muda + p.pengatur_muda,
          pengatur_muda_tk_1: sum.pengatur_muda_tk_1 + p.pengatur_muda_tk_1,
          pengatur: sum.pengatur + p.pengatur,
          pengatur_tk_1: sum.pengatur_tk_1 + p.pengatur_tk_1,
          penata_muda: sum.penata_muda + p.penata_muda,
          penata_muda_tk_1: sum.penata_muda_tk_1 + p.penata_muda_tk_1,
          penata: sum.penata + p.penata,
          penata_tk_1: sum.penata_tk_1 + p.penata_tk_1,
          pembina: sum.pembina + p.pembina,
          pembina_tk_1: sum.pembina_tk_1 + p.pembina_tk_1,
          pembina_utama_muda: sum.pembina_utama_muda + p.pembina_utama_muda,
          pembina_utama_madya: sum.pembina_utama_madya + p.pembina_utama_madya,
          pembina_utama: sum.pembina_utama + p.pembina_utama,
          belum_pangkat_gol: sum.belum_pangkat_gol + p.belum_pangkat_gol,
        }),
        {
          juru_muda: 0,
          juru_muda_tk_1: 0,
          ...
          pembina: 0,
          pembina_tk_1: 0,
          pembina_utama_muda: 0,
          pembina_utama_madya: 0,
          pembina_utama: 0,
          belum_pangkat_gol: 0,
        },
      );
    ...
    if (panggolFakultasList) {
      return panggolFakultasList.reduce(
        (sum, f) => ({
          juru_muda: sum.juru_muda + f.juru_muda,
          juru_muda_tk_1: sum.juru_muda_tk_1 + f.juru_muda_tk_1,
          juru: sum.juru + f.juru,
          juru_tk_1: sum.juru_tk_1 + f.juru_tk_1,
          pengatur_muda: sum.pengatur_muda + f.pengatur_muda,
          pengatur_muda_tk_1: sum.pengatur_muda_tk_1 + f.pengatur_muda_tk_1,
          pengatur: sum.pengatur + f.pengatur,
          pengatur_tk_1: sum.pengatur_tk_1 + f.pengatur_tk_1,
          penata_muda: sum.penata_muda + f.penata_muda,
          penata_muda_tk_1: sum.penata_muda_tk_1 + f.penata_muda_tk_1,
          penata: sum.penata + f.penata,
          penata_tk_1: sum.penata_tk_1 + f.penata_tk_1,
          pembina: sum.pembina + f.pembina,
          pembina_tk_1: sum.pembina_tk_1 + f.pembina_tk_1,
          pembina_utama_muda: sum.pembina_utama_muda + f.pembina_utama_muda,
          pembina_utama_madya: sum.pembina_utama_madya + f.pembina_utama_madya,
          pembina_utama: sum.pembina_utama + f.pembina_utama,
          belum_pangkat_gol: sum.belum_pangkat_gol + f.belum_pangkat_gol,
        }),
        {
          juru_muda: 0,
          juru_muda_tk_1: 0,
