...
import { kelulusanService, KelulusanStatistics } from "@/lib/services/public/kelulusanService";
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16 space-y-4">
              <div className="h-10 bg-gray-50 dark:bg-gray-600 rounded-lg w-96 mx-auto animate-shimmer"></div>
              <div className="h-px bg-gradient-to-r from-transparent via-gray-100 to-transparent dark:via-gray-500 w-20 mx-auto"></div>
              <div className="h-6 bg-gray-50 dark:bg-gray-600 rounded w-80 mx-auto animate-shimmer"></div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="bg-gray-50 dark:bg-gray-600 rounded-xl p-6 shadow-lg animate-shimmer">
                  ...
                  <div className="h-4 bg-gray-100 dark:bg-gray-500 rounded w-40"></div>
                </div>
              ))}
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {[1, 2].map((i) => (
                <div key={i} className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden animate-shimmer">
                  ...
                  <div className="p-6">
                    <div className="h-[380px] bg-gray-50 dark:bg-gray-600 rounded-xl flex items-center justify-center animate-soft-pulse">
            ...
            <div className="mt-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden animate-shimmer">
              <div className="px-6 py-5 bg-gray-50 dark:bg-gray-600">
                <div className="h-6 bg-gray-100 dark:bg-gray-500 rounded w-64"></div>
              </div>
              <div className="p-6">
                <div className="h-[450px] bg-gray-50 dark:bg-gray-600 rounded-xl flex items-center justify-center animate-soft-pulse">
                  <svg className="w-16 h-16 text-gray-100 dark:text-gray-400 animate-soft-pulse" fill="currentColor" viewBox="0 0 20 20">
