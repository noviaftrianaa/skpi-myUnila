...
export default function Hero({
  ...
  return (
    <section
      className={cn(
        "relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 pt-20 sm:pt-24 md:pt-28 lg:pt-32 pb-8 sm:pb-12 md:pb-16 lg:pb-20 px-3 sm:px-4 md:px-6 overflow-hidden",
        className
      )}
    >
      ...
      {/* Content */}
      <motion.div
        className="relative z-10 max-w-6xl mx-auto text-center px-2 sm:px-4 md:px-6"
      ...
      >
        ...
        {/* Title with Gradient */}
        <motion.h1
          className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-3 sm:mb-4 md:mb-5 lg:mb-6 leading-tight px-2"
        ...
        {/* Subtitle */}
        <motion.p
          className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-semibold text-gray-700 mb-2 sm:mb-3 px-3 leading-snug"
          variants={itemVariants}
        >
          {subtitle}
        </motion.p>
        ...
        {/* Description */}
        <motion.p
          className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-600 mb-5 sm:mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed px-3"
          variants={itemVariants}
        >
          {description}
        </motion.p>
        ...
        {showCTA && (
          <motion.div variants={itemVariants} className="mb-6 sm:mb-8 md:mb-10 lg:mb-12 max-w-3xl mx-auto px-1">
            <GlobalSearch variant="hero" className="w-full" />

            {/* Quick Links below search */}
            <div className="flex flex-wrap justify-center items-center gap-x-2 gap-y-1.5 mt-2.5 sm:mt-3 md:mt-4 px-2">
              <span className="text-[10px] sm:text-xs md:text-sm text-gray-500">Coba cari:</span>
              <Link href="/search?q=teknik informatika&category=prodi" className="text-[10px] sm:text-xs md:text-sm text-myunila hover:underline">
                Teknik Informatika
              </Link>
              <span className="text-gray-300 hidden sm:inline text-xs">•</span>
              <Link href="/search?q=machine learning&category=penelitian" className="text-[10px] sm:text-xs md:text-sm text-myunila hover:underline">
                Machine Learning
              </Link>
              <span className="text-gray-300 hidden sm:inline text-xs">•</span>
              <Link href="/search?q=dosen&category=dosen" className="text-[10px] sm:text-xs md:text-sm text-myunila hover:underline">
                Dosen
              </Link>
            </div>
          </motion.div>
        ...
        <motion.div
          variants={itemVariants}
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5 lg:gap-6 max-w-6xl mx-auto mt-8 sm:mt-12 md:mt-16 lg:mt-20 mb-4 sm:mb-6 md:mb-8 lg:mb-10"
        >
          {[
            {
            ...
            >
              ...
              <div className={`relative inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-lg sm:rounded-xl bg-gradient-to-br ${feature.gradient} text-white mb-2.5 sm:mb-3 md:mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                <div className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-8">
                  {feature.icon}
                </div>
              </div>
              <h3 className="relative text-sm sm:text-base md:text-lg font-bold text-gray-800 mb-1 sm:mb-1.5 md:mb-2">{feature.title}</h3>
              <p className="relative text-[10px] sm:text-xs md:text-sm text-gray-600 leading-relaxed">{feature.description}</p>
            </motion.div>
          ))}
        </motion.div>
      </motion.div>
      ...
      <motion.div
        className="absolute bottom-3 sm:bottom-4 md:bottom-6 lg:bottom-8 left-1/2 transform -translate-x-1/2 z-20"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <motion.button
          ...
          className="flex flex-col items-center gap-0.5 sm:gap-1 md:gap-2 text-gray-400 cursor-pointer hover:text-myunila transition-colors focus:outline-none focus:ring-2 focus:ring-myunila/50 rounded-lg p-1 sm:p-1.5 md:p-2"
          animate={{ y: [0, 8, 0] }}
          transition={{
            duration: 2,
            repeat: Infinity,
        ...
        >
          <span className="text-[9px] sm:text-[10px] md:text-xs font-semibold uppercase tracking-wider">Scroll</span>
