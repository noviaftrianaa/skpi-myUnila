          ...
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1 border-b border-gray-200">
                <h3 className="text-xl font-bold text-gray-800">Pilih Peran</h3>
              ...
              <ModalBody className="py-6">
                {approvedRoles.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">Tidak ada peran yang tersedia</p>
                  </div>
                )}
              </ModalBody>
              <ModalFooter className="border-t border-gray-200">
                ...
                <Button
                  className="bg-myunila text-white hover:bg-blue-700"
