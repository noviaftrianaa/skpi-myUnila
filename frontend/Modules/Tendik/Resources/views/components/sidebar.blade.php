        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/inpassing')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Inpassing</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/jabatan-fungsional')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Jabatan Fungsional</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/kepangkatan')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Kepangkatan</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/penempatan')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Penempatan</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/pendidikan-formal')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Pendidikan Formal</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/diklat')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Diklat Tendik</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/tes')) ? 'active' : '' }}" href="{{url('tendik/tes')}}">
                    ...
                    <span class="nav-link-text ms-1">Tes (IELTS, TOEFL dll)</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/perencanaan')) ? 'active' : '' }}"
                    href="{{url('tendik/perencanaan')}}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/pengoprasian')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Pengoprasian</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/pengevaluasian')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Pengevaluasian</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/pengembangan')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Pengembangan</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/karya-tulis')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Karya Tulis</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/penerjemahan')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Penerjemahan</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/pembuatan-pedoman')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Pembuatan Pedoman</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/penemuan-teknologi')) ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>penemuan-teknologi</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-2169.000000, -745.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(453.000000, 454.000000)">
                    ...
                    <span class="nav-link-text ms-1">Penemuan Teknologi</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/pengajaran')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Pengajaran</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/pembimbingan')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Pembimbingan</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/seminar-loka-karya')) ? 'active' : '' }}"
                    href="{{url('tendik/seminar-loka-karya')}}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>seminar-loka-karya</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-2169.000000, -745.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(453.000000, 454.000000)">
                    ...
                    <span class="nav-link-text ms-1">Seminar/Loka Karya</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/anggota-profesi')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Anggota Profesi</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/beasiswa')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Beasiswa</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('tendik/kesejahtraan')) ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Kesejahtraan</span>
                </a>
            </li>
            <li class="nav-item">
