...
@section('title', 'Penemuan Teknologi')

@section('content')
{{-- start penemuan teknologi --}}
                ...
                <div class="card-header pb-0 p-3 mb-0">
                    <div class="row">
                        <div class="col-6 d-flex align-items-center">
                            <p class="text-uppercase text-sm font-weight-bolder mb-0">Penemuan Teknologi</p>
                        </div>
                ...
                <div class="card-body p-3 pt-0">
                    <div class="table-responsive p-0">
                        <table class="table">
                            ...
                            <tbody>
                                {{-- @foreach ($listPenemuanTeknologi as $value)
                                    <tr>
                                        <td>
