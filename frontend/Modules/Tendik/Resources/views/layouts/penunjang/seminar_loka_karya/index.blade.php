...
@section('title', 'Seminar/Lokakarya')

@section('content')
{{-- start Seminar/Lokakarya --}}
                ...
                <div class="card-header pb-0 p-3 mb-0">
                    <div class="row">
                        <div class="col-6 d-flex align-items-center">
                            <p class="text-uppercase text-sm font-weight-bolder mb-0">Seminar/Lokakarya</p>
                        </div>
                        ...
                        <table class="table">
                            <thead class="bg-dark text-white">
                                <tr>
                                    ...
                                    <th class="text-uppercase text-xxs font-weight-bolder">Jumlah Jam</th>
                                    <th class="text-uppercase text-xxs font-weight-bolder">Tahun</th>
                                </tr>
                            </thead>
                            <tbody>
                                {{-- @foreach ($listSeminarLokaKarya as $value)
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span class="text-xs font-weight-bold"> {{ $value['jumlah_jam'] }} </span>
                                        </td>
                                        <td>
