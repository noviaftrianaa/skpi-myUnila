          ...
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                ...
                <h5 class="font-weight-bolder mb-0">10 ( Aktif )</h5>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                ...
                <h5 class="font-weight-bolder mb-0">3.03</h5>
              </div>
            </div>
            <div class="col-4 text-end">
              <div class="icon icon-shape btn-primary shadow text-center border-radius-md">
          ...
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                ...
                <h5 class="font-weight-bolder mb-0" style=color:#fe2200>Belum Bayar</h5>
              </div>
            </div>
            <div class="col-4 text-end">
              <div class="icon icon-shape btn-primary shadow text-center border-radius-md">
          ...
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                ...
                <h6 class="font-weight-bolder mb-0">Beasiswa PPA</h6>
        ...
        <div class="card-body p-3">
          ...
          <div class="ml-3 w-100 p-1">
            ...
            <div class="button mt-2 d-flex flex-row align-items-center">
              <a href="{{url('stakeholder/data-mahasiswa')}}" class="btn btn-sm btn-round btn-info">&nbsp;&nbsp;Detail</a>
            </div>
          </div>
  ...
  <div class="col-lg-3 mb-lg-0 mb-4">
    <div class="card z-index-2">
      ...
      <div class="card-body p-0">
        ...
        <div class="button mt-2 d-flex flex-row align-items-center">
          <a href="{{url('stakeholder/status-pembayaran-spp')}}" class="btn btn-sm btn-round btn-info">&nbsp;&nbsp;Detail</a>
        </div>
    ...
    <div class="col-lg-12 mb-lg-0 mb-4 ">
      <div class="card z-index-2">
        <div class="card-header pb-0">
          ...
          <p class="text-sm">
            <div class="button mt-2 d-flex flex-row align-items-center">
              <a href="{{url('stakeholder/riwayat-studi-unduh')}}" class="btn btn-sm btn-round mb-2 me-3 btn-info"><i class="fa fa-download text-white"></i>&nbsp;&nbsp;Unduh</a>
              <a href="{{url('stakeholder/riwayat-studi-cetak')}}" class="btn btn-sm btn-round mb-2 me-3 btn-info"><i class="fa fa-print text-white"></i>&nbsp;&nbsp;Cetak</a>
            </div>
          </p>
        </div>
        <div class="card-body p-3">
