        ...
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show active" id="krs" role="tabpanel" aria-labelledby="krs-tab">
            <div class="card">
                ...
                <a href="{{url('stakeholder/riwayat-studi/cetak')}}" class="btn btn-sm btn-round btn-info"><i class="fa fa-print text-white"></i>&nbsp;&nbsp;Cetak</a>
              </h5>
