<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="/alumni" target="_blank">
      ...
      <span class="ms-1">Orang Tua - Zuliana Nurfadlillah</span>
    </a>
  </div>
  <hr class="horizontal dark mt-0 mt-5">
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (request()->is('stakeholder/data-mahasiswa')) ? 'active' : '' }}" href="{{url('stakeholder/data-mahasiswa')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>shop </title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (request()->is('stakeholder/riwayat-studi')) ? 'active' : '' }}" href="{{url('stakeholder/riwayat-studi')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>shop </title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (request()->is('stakeholder/status-pembayaran-spp')) ? 'active' : '' }}" href="{{url('stakeholder/status-pembayaran-spp')}}">
            ...
            <span class="nav-link-text ms-1">Status Pembayaran SPP</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ (request()->is('stakeholder/status-beasiswa')) ? 'active' : '' }}" href="{{url('stakeholder/status-beasiswa')}}">
            ...
            <span class="nav-link-text ms-1">Status Beasiswa</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (request()->is('stakeholder/kemajuan-belajar')) ? 'active' : '' }}" href="{{url('stakeholder/kemajuan-belajar')}}">
            ...
            <span class="nav-link-text ms-1">Kemajuan Belajar </span>
          </a>
        </li>
