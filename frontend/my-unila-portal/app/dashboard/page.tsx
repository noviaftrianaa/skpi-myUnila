...
export default function DashboardPage() {
  ...
  const [applications, setApplications] = useState<AppCategory[]>([
    {
      ...
      apps: [
        ...
        {
          id: "myunila-siakad-ppg",
          name: "Siakad PPG",
          description: "Sistem Akademik PPG",
        ...
        },
        {
          ...
          name: "Siakad Profesi Dokter",
          description: "Sistem Akademik Profesi Dokter",
  ...
  const announcements = [
    ...
    },
    {
      ...
      description: "Dalam rangka implementasi kebijakan ITS, DPTSI mengumumkan bahwa akun email...",
      category: "Lainnya",
