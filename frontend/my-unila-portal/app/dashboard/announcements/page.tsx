...
export default function AnnouncementsPage() {
  ...
  const announcements = [
    ...
    },
    {
      ...
      description:
        "Dalam rangka implementasi kebijakan Universitas Lampung, DPTSI mengumumkan bahwa akun email yang tidak aktif selama 6 bulan berturut-turut akan dihapus secara otomatis.",
      category: "Lainnya",
