...
BEGIN
  ...
  VALUES ('EF9BA12F-7BDD-4995-8199-20B4A823CE92', 'Dashboard', '/dashboard/data-unila', 1, 1, 1, 'heroicons:chart-bar-square', 0, 'E14530EB-EFE4-4FAE-91D2-5A0396DD362F', NULL, GETDATE(), GETDATE(), GETDATE());
END
...
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('A2A1688A-4A98-4BFB-AFDA-9E80CBBBAE56', 'Data Mahasiswa', '#data-mahasiswa', 2, 1, 1, 'heroicons:academic-cap', 0, 'E14530EB-EFE4-4FAE-91D2-5A0396DD362F', NULL, GETDATE(), GETDATE(), GETDATE());
END
...
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('D54938FB-F2E0-42CE-B5CE-7DFC3CA7E6EE', 'Lulusan', '/dashboard/data-unila/mahasiswa/lulusan', 2, 1, 1, NULL, 1, 'E14530EB-EFE4-4FAE-91D2-5A0396DD362F', 'A2A1688A-4A98-4BFB-AFDA-9E80CBBBAE56', GETDATE(), GETDATE(), GETDATE());
END
...
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('3925A7BE-FF51-46A9-934B-F469AE2D1B3B', 'Data Dosen & SDM', '#data-dosen', 3, 1, 1, 'heroicons:user-group', 0, 'E14530EB-EFE4-4FAE-91D2-5A0396DD362F', NULL, GETDATE(), GETDATE(), GETDATE());
END
IF NOT EXISTS (SELECT 1 FROM man_akses.menu WHERE id_menu = 'F44D2A30-3402-43DD-A050-FB4DB8AC0CA1')
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('F44D2A30-3402-43DD-A050-FB4DB8AC0CA1', 'Aktivitas Mahasiswa', '/dashboard/data-unila/mahasiswa/aktivitas', 3, 1, 1, NULL, 1, 'E14530EB-EFE4-4FAE-91D2-5A0396DD362F', 'A2A1688A-4A98-4BFB-AFDA-9E80CBBBAE56', GETDATE(), GETDATE(), GETDATE());
END
IF NOT EXISTS (SELECT 1 FROM man_akses.menu WHERE id_menu = '306098AB-C01C-4312-847B-F3D20C812CAB')
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('306098AB-C01C-4312-847B-F3D20C812CAB', 'Data Tridarma', '#data-tridarma', 4, 1, 1, 'heroicons:beaker', 0, 'E14530EB-EFE4-4FAE-91D2-5A0396DD362F', NULL, GETDATE(), GETDATE(), GETDATE());
END
IF NOT EXISTS (SELECT 1 FROM man_akses.menu WHERE id_menu = 'E6F774A8-1129-42E9-952E-3F7C473C39D0')
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('E6F774A8-1129-42E9-952E-3F7C473C39D0', 'Prestasi', '/dashboard/data-unila/tridarma/prestasi', 4, 1, 1, NULL, 1, 'E14530EB-EFE4-4FAE-91D2-5A0396DD362F', '306098AB-C01C-4312-847B-F3D20C812CAB', GETDATE(), GETDATE(), GETDATE());
END
IF NOT EXISTS (SELECT 1 FROM man_akses.menu WHERE id_menu = 'DD6793BA-11F8-4C9B-B332-E77D2D5634FC')
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('DD6793BA-11F8-4C9B-B332-E77D2D5634FC', 'Data Akademik', '#data-akademik', 5, 1, 1, 'heroicons:building-library', 0, 'E14530EB-EFE4-4FAE-91D2-5A0396DD362F', NULL, GETDATE(), GETDATE(), GETDATE());
END
IF NOT EXISTS (SELECT 1 FROM man_akses.menu WHERE id_menu = 'A1C7312A-0E39-4125-965D-9FCA21C7137D')
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('A1C7312A-0E39-4125-965D-9FCA21C7137D', 'Data Kerjasama', '/dashboard/data-unila/kerjasama', 6, 1, 1, 'heroicons:globe-alt', 0, 'E14530EB-EFE4-4FAE-91D2-5A0396DD362F', NULL, GETDATE(), GETDATE(), GETDATE());
END
IF NOT EXISTS (SELECT 1 FROM man_akses.menu WHERE id_menu = '45329BDC-C12D-437B-BB0D-FCF1F5B438D8')
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('45329BDC-C12D-437B-BB0D-FCF1F5B438D8', 'Data Keuangan', '#data-keuangan', 7, 1, 1, 'heroicons:currency-dollar', 0, 'E14530EB-EFE4-4FAE-91D2-5A0396DD362F', NULL, GETDATE(), GETDATE(), GETDATE());
END
IF NOT EXISTS (SELECT 1 FROM man_akses.menu WHERE id_menu = 'C784B3D6-7F58-4720-A91A-C4438F178240')
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('C784B3D6-7F58-4720-A91A-C4438F178240', 'Tracer Study', '/dashboard/data-unila/tracer', 8, 1, 1, 'heroicons:arrow-trending-up', 0, 'E14530EB-EFE4-4FAE-91D2-5A0396DD362F', NULL, GETDATE(), GETDATE(), GETDATE());
END
GO
-- Menus for manajemen-akses
...
END
GO
-- Menus for project-management
IF NOT EXISTS (SELECT 1 FROM man_akses.menu WHERE id_menu = 'F12F43CA-58DC-47D9-8663-425AF008AB4B')
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('F12F43CA-58DC-47D9-8663-425AF008AB4B', 'Dashboard', '/dashboard/project-management', 1, 1, 1, 'heroicons:home', 0, '432F1D35-9913-4AF1-922A-01C6A0FC3940', NULL, GETDATE(), GETDATE(), GETDATE());
END
IF NOT EXISTS (SELECT 1 FROM man_akses.menu WHERE id_menu = '051FE792-C966-40B9-979A-831181C49000')
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('051FE792-C966-40B9-979A-831181C49000', 'Analytics', '/dashboard/project-management/analytics', 2, 1, 1, 'heroicons:chart-bar', 0, '432F1D35-9913-4AF1-922A-01C6A0FC3940', NULL, GETDATE(), GETDATE(), GETDATE());
END
IF NOT EXISTS (SELECT 1 FROM man_akses.menu WHERE id_menu = 'D0335B4C-B044-4AE1-BD72-C8426A9F812D')
BEGIN
  INSERT INTO man_akses.menu (id_menu, nm_menu, nm_file, urutan_menu, a_aktif, a_tampil, icon, level_menu, id_aplikasi, id_group_menu, tgl_create, last_update, last_sync)
  VALUES ('D0335B4C-B044-4AE1-BD72-C8426A9F812D', 'Pengaturan', '/dashboard/project-management/settings', 3, 1, 1, 'heroicons:cog-6-tooth', 0, '432F1D35-9913-4AF1-922A-01C6A0FC3940', NULL, GETDATE(), GETDATE(), GETDATE());
END
GO
-- ==========================================
-- 4. INSERT missing menu_role (RBAC)
-- ==========================================
-- menu_role for data-unila (253 records)
...
GO
-- menu_role for manajemen-akses (32 records)
...
GO
-- menu_role for project-management (6 records)
