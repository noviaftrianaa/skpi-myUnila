-- ============================================================================
-- akreditasi.akreditasi_prodi_alias — alias BAN-PT name → pdrd.sms.id_sms
-- ============================================================================
...
-- Drop existing table jika ada (clean start)
IF OBJECT_ID('akreditasi.akreditasi_prodi_alias', 'U') IS NOT NULL
    DROP TABLE akreditasi.akreditasi_prodi_alias;
GO

-- Drop old "myunila" schema table jika ada (migrasi dari schema lama)
IF OBJECT_ID('myunila.akreditasi_prodi_alias', 'U') IS NOT NULL
    DROP TABLE myunila.akreditasi_prodi_alias;
GO

IF SCHEMA_ID('akreditasi') IS NULL EXEC('CREATE SCHEMA akreditasi');
GO

CREATE TABLE akreditasi.akreditasi_prodi_alias (
...
CREATE INDEX ix_akr_alias_id_sms ON akreditasi.akreditasi_prodi_alias (id_sms);
GO
