...
/* Created on:     06/02/2024 10:29:22                          */
/*==============================================================*/
...
create table beasiswa.beasiswa_sdm (
   ...
   a_msh_terima         numeric(1)           not null default 1
...
create table ref.lembaga_pengangkat (
   ...
   a_ref_pddikti        numeric(1)           not null default 0
      constraint ckc_a_ref_pddikti_lembaga_3 check (a_ref_pddikti between 0 and 1 and a_ref_pddikti in (0,1)),
   a_ref_unila          numeric(1)           not null default 0
      constraint ckc_a_ref_unila_lembaga_3 check (a_ref_unila between 0 and 1 and a_ref_unila in (0,1)),
