...
<head>
    ...
    <title>Captcha Verification : SI-MA v1.0 UNILA</title>
    <link rel="stylesheet"
    ...
    <div class="login-box">
        ...
        <div class="card ">
            <div class="card-header text-center mt-4">
                ...
                <p class="text-sm mt-4"><strong>CAPTCHA VERIFICATION</strong><br>Sistem Informasi Manajemen Akses<br>Univeritas Lampung (UNILA)
                </p>
            </div>
            <div class="card-body">
