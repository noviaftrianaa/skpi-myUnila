            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="#" method="post" enctype="multipart/form-data" id="formPjDeleteMdl">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                Yakin ingin menghapus PJ atas nama <strong id="deleteNmPjMdl"></strong> dari {{$data->nm_aplikasi}} ?
                            </div>
                        </div>
                        <div class="modal-footer no-bd">
                            <button type="button" class="btn btn-link" data-dismiss="modal">Tutup</button>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group form-group-default">
                                    ...
                                    <input name="nm_menu" id="nm_menu" type="text" class="form-control" placeholder="Masukkan Nama Menu" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group form-group-default">
                                    <label>Nama File</label>
                                    <input name="nm_file" id="nm_file" type="text" class="form-control" placeholder="Masukkan Nama File" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group form-group-default">
                                    <label>Urutan Menu</label>
                                    <input name="urutan_menu" id="urutan_menu" type="number" class="form-control" placeholder="Masukkan Urutan Menu" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group form-group-default">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group form-group-default">
                                    ...
                                    <input name="level_menu" id="level_menu" type="number" class="form-control" placeholder="level menu">
                                </div>
                            </div>
                            <div class="col-sm-6 col-12">
                                <div class="form-group form-group-default">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="#" method="post" enctype="multipart/form-data" id="formMenuDeleteMdl">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                Yakin ingin menghapus Menu <strong id="deleteNmMenuMdl"></strong> dari {{$data->nm_aplikasi}} ?
                            </div>
                        </div>
                        <div class="modal-footer no-bd">
                            <button type="button" class="btn btn-link" data-dismiss="modal">Tutup</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        tpj.on('click', '#editPJ', function() {
            ...
            $('#formPjMdl').prop("action", "{{ route('aplikasi.pj_aplikasi.update', '') }}"+"/"+ids);
        ...
        tpj.on('click', '#deletePJ', function() {
            ...
            $('#formPjDeleteMdl').prop("action", "{{ route('aplikasi.pj_aplikasi.destroy', '') }}"+"/"+ids);
