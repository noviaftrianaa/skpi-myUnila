...
class PengaturanTableAplikasi extends Model
{
    ...
    protected $fillable = ['id_pengaturan_table_app','id_table_app','id_aplikasi','a_boleh_insert','a_boleh_show','a_boleh_delete','a_boleh_update','tgl_create','last_update','expired_date','last_sync'];
