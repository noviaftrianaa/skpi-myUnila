...
class AksesTableAplikasi extends Model
{
    ...
    protected $fillable = ['id_akses_table_app','id_table_app','id_aplikasi','a_boleh_get','a_boleh_insert','a_boleh_show','a_boleh_delete','a_boleh_update','a_aktif','tgl_create','last_update','soft_delete','last_sync','id_updater'];
