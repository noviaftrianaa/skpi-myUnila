...
class WSAuthorization extends Model
{
    ...
    protected $fillable = ['id_ws_authorization','id_pengguna','id_ws_endpoint','id_aplikasi','a_active','created_at','updated_at','last_sync','id_creator','id_updater','soft_delete'];
