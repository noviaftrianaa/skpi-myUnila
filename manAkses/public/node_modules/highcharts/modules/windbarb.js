...
*/
(function(a){"object"===typeof module&&module.exports?(a["default"]=a,module.exports=a):"function"===typeof define&&define.amd?define("highcharts/modules/windbarb",["highcharts"],function(k){a(k);a.Highcharts=k;return a}):a("undefined"!==typeof Highcharts?Highcharts:void 0)})(function(a){function k(a,g,k,n){a.hasOwnProperty(g)||(a[g]=n.apply(null,k))}a=a?a._modules:{};k(a,"mixins/on-series.js",[a["parts/Globals.js"],a["parts/Utilities.js"]],function(a,g){var t=g.defined,k=a.seriesTypes,u=a.stableSort;
return{getPlotBox:function(){return a.Series.prototype.getPlotBox.call(this.options.onSeries&&this.chart.get(this.options.onSeries)||this)},translate:function(){k.column.prototype.translate.apply(this);var a=this,l=a.options,f=a.chart,h=a.points,e=h.length-1,c,b=l.onSeries;b=b&&f.get(b);l=l.onKey||"y";var d=b&&b.options.step,g=b&&b.points,p=g&&g.length,n=f.inverted,r=a.xAxis,x=a.yAxis,v=0,q;if(b&&b.visible&&p){v=(b.pointXOffset||0)+(b.barW||0)/2;f=b.currentDataGrouping;var y=g[p-1].x+(f?f.totalRange:
0);u(h,function(b,c){return b.x-c.x});for(l="plot"+l[0].toUpperCase()+l.substr(1);p--&&h[e];){var m=g[p];f=h[e];f.y=m.y;if(m.x<=f.x&&"undefined"!==typeof m[l]){if(f.x<=y&&(f.plotY=m[l],m.x<f.x&&!d&&(q=g[p+1])&&"undefined"!==typeof q[l])){var w=(f.x-m.x)/(q.x-m.x);f.plotY+=w*(q[l]-m[l]);f.y+=w*(q.y-m.y)}e--;p++;if(0>e)break}}}h.forEach(function(b,d){b.plotX+=v;if("undefined"===typeof b.plotY||n)0<=b.plotX&&b.plotX<=r.len?n?(b.plotY=r.translate(b.x,0,1,0,1),b.plotX=t(b.y)?x.translate(b.y,0,0,0,1):0):
...
Math.sin(e[d]*a.deg2rad);return[h.reduce(function(b,c){return b+c},0)/h.length,Math.atan2(b,c)/a.deg2rad]})}var u=g.animObject,t=g.isNumber,l=g.pick;g=a.noop;var f=a.seriesType;n();f("windbarb","column",{dataGrouping:{enabled:!0,approximation:"windbarb",groupPixelWidth:30},lineWidth:2,onSeries:null,states:{hover:{lineWidthPlus:0}},tooltip:{pointFormat:'<span style="color:{point.color}">\u25cf</span> {series.name}: <b>{point.value}</b> ({point.beaufort})<br/>'},vectorLength:20,colorKey:"value",yOffset:-20,
...
[f+this.options.xOffset+(c&&!this.onSeries?b:0),g+this.options.yOffset-(c?0:b+e.pos-a.plotTop)]},this)},animate:function(a){a?this.markerGroup.attr({opacity:.01}):(this.markerGroup.animate({opacity:1},u(this.options.animation)),this.animate=null)},invertGroups:g,getExtremes:g},{isValid:function(){return t(this.value)&&0<=this.value}});""});k(a,"masters/modules/windbarb.src.js",[],function(){})});
