...
31:{title:"Non-unique point or node id",text:"<h1>Non-unique point or node id</h1><p>This error occurs when using the same <code>id</code> for two or more points or nodes.</p>"},meta:{files:"errors/10/readme.md errors/10/enduser.md errors/11/readme.md errors/12/readme.md errors/13/readme.md errors/14/readme.md errors/15/readme.md errors/16/readme.md errors/17/readme.md errors/18/readme.md errors/19/readme.md errors/20/readme.md errors/21/readme.md errors/22/readme.md errors/23/readme.md errors/24/readme.md errors/25/readme.md errors/26/readme.md errors/27/readme.md errors/28/readme.md errors/29/readme.md errors/30/readme.md errors/31/readme.md".split(" ")}}});
b(a,"modules/debugger.src.js",[a["parts/Globals.js"],a["parts/Utilities.js"]],function(a,b){var f=b.isNumber;b=a.addEvent;var d=a.setOptions,g=a.each;d({chart:{displayErrors:!0}});b(a.Chart,"displayError",function(b){var c=b.code,e=this.options.chart;b=this.renderer;this.errorElements&&g(this.errorElements,function(a){a&&a.destroy()});if(e&&e.displayErrors&&b){this.errorElements=[];c=f(c)?"Highcharts error #"+c+": "+a.errorMessages[c].text:c;e=this.chartWidth;var d=this.chartHeight;c=c.replace(/<h1>(.*)<\/h1>/g,
'<br><span style="font-size: 24px">$1</span><br>').replace(/<\/p>/g,"</p><br>");this.errorElements[0]=b.rect(2,2,e-4,d-4).attr({"stroke-width":4,stroke:"#ff0000",zIndex:3}).add();this.errorElements[1]=b.label(c,0,0,"rect",void 0,void 0,void 0,void 0,"debugger").css({color:"#ffffff",width:e-16,padding:0}).attr({fill:"rgba(255, 0, 0, 0.9)",width:e,padding:8,zIndex:10}).add();this.errorElements[1].attr({y:d-this.errorElements[1].getBBox().height})}});b(a.Chart,"beforeRedraw",function(){var a=this.errorElements;
a&&a.length&&g(a,function(a){a.destroy()});this.errorElements=null})});b(a,"masters/modules/debugger.src.js",[],function(){})});
