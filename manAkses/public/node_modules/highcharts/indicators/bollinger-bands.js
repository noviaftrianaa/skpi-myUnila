...
arguments);this.options=q({topLine:{styles:{lineColor:this.color}},bottomLine:{styles:{lineColor:this.color}}},this.options)},getValues:function(a,b){var e=b.period,c=b.standardDeviation,f=a.xData,t=(a=a.yData)?a.length:0,h=[],v=[],m=[],g;if(!(f.length<e)){var n=d(a[0]);for(g=e;g<=t;g++){var w=f.slice(g-e,g);var p=a.slice(g-e,g);var k=u.prototype.getValues.call(this,{xData:w,yData:p},b);w=k.xData[0];k=k.yData[0];for(var q=0,r=p.length,x=0;x<r;x++){var l=(n?p[x][b.index]:p[x])-k;q+=l*l}l=Math.sqrt(q/
