...
{preserveAspectRatio:"none"},m=function(a,b){a.setAttributeNS?a.setAttributeNS("http://www.w3.org/1999/xlink","href",b):a.setAttribute("hc-svg-href",b)},d=function(b){m(v.element,a);l.call(v,b)};1<arguments.length&&p(G,{x:b,y:c,width:r,height:g});var v=this.createElement("image").attr(G);l?(m(v.element,"data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),G=new W.Image,e(G,"load",d),G.src=a,G.complete&&d({})):m(v.element,a);return v},symbol:function(b,c,e,r,l,G){var m=this,
